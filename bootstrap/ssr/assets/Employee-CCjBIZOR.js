        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (active_tab.value == 1) {
              ...
              if ((unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && ((_c = selected_employee.value) == null ? void 0 : _c.id) > 0) {
              ...
              if ((unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && ((_d = selected_employee.value) == null ? void 0 : _d.id) > 0) {
            ...
            if (active_tab.value == 2) {
              ...
              if ((unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && ((_e = selected_customer.value) == null ? void 0 : _e.id) > 0) {
                              ...
                              createVNode("div", { class: "card border-0 shadow-sm p-3" }, [
                                ...
                                createVNode("div", { class: "row g-2 mt-2" }, [
                                  ...
                                  createVNode("div", { class: "col-12 col-lg-6" }, [
                                    ...
                                    (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && ((_c2 = selected_employee.value) == null ? void 0 : _c2.id) > 0 ? (openBlock(), createBlock("div", {
                                      key: 2,
                                      class: "d-flex"
                                    }, [
                                    ...
                                    (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && ((_d2 = selected_employee.value) == null ? void 0 : _d2.id) > 0 ? (openBlock(), createBlock(_sfc_main$2, {
                                      key: 3,
                                      message: unref(form_update_employee).errors.roles_id,
                                      class: "mt-2"
                          ...
                          active_tab.value == 2 ? (openBlock(), createBlock("div", {
                            ...
                            createVNode("div", { class: "col-12" }, [
                              createVNode("div", { class: "card border-0 shadow-sm p-3" }, [
                                ...
                                (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && ((_a2 = selected_customer.value) == null ? void 0 : _a2.id) > 0 ? (openBlock(), createBlock("button", {
                                  key: 0,
                                  onClick: ($event) => confirmation(
                                    _ctx.route(
                                      "employee.add",
...
//# sourceMappingURL=Employee-CCjBIZOR.js.map
