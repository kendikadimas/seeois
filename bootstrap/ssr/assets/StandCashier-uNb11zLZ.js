...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function openTodayReceiptModal(sale) {
      ...
      form_print_receipt.value.customer = ((_a = sale.customer) == null ? void 0 : _a.name) ?? sale.customer ?? "—";
                            ...
                            return openBlock(), createBlock("ul", {
                              ...
                              createVNode("div", { class: "d-flex align-items-start gap-2" }, [
                                createVNode("div", { class: "me-auto" }, [
                                  createVNode("span", { class: "d-block text-primary-emphasis fw-semibold" }, toDisplayString(((_a3 = sale.customer) == null ? void 0 : _a3.name) ?? sale.customer ?? "—"), 1),
                                  createVNode("span", {
                                    class: "text-secondary d-block",
                                    style: { "font-size": "0.75rem" }
                                  }, [
                                    createVNode("i", { class: "bi bi-telephone me-1" }),
                                    createTextVNode(toDisplayString(((_b3 = sale.customer) == null ? void 0 : _b3.phone) ?? "—"), 1)
                                  ]),
                                  createVNode("span", {
                                ...
                                createVNode("div", { class: "text-end" }, [
                                  ...
                                  createVNode("span", {
                                    class: "text-secondary d-block",
                                    style: { "font-size": "0.75rem" }
                                  }, toDisplayString(((_c3 = __props.payment_method_list.find((p) => p.id == sale.payment_method_id)) == null ? void 0 : _c3.name) ?? "—"), 1)
                                ]),
                                createVNode("button", {
...
//# sourceMappingURL=StandCashier-uNb11zLZ.js.map
