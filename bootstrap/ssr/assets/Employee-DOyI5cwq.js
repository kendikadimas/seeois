import { ref, onMounted, onUnmounted, watch, withCtx, unref, createVNode, toDisplayString, Transition, openBlock, createBlock, createCommentVNode, createTextVNode, withDirectives, vModelText, Fragment, renderList, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(StaffLayout, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="container me-lg-0 mx-auto mb-5"${_scopeId}><div class="row gx-4 mt-4 px-lg-0 px-2"${_scopeId}><div class="col-lg-6"${_scopeId}><div class="row mb-4"${_scopeId}><div class="col-12"${_scopeId}><div class="card shadow-sm border-light border-4"${_scopeId}><div class="d-flex"${_scopeId}><button class="${ssrRenderClass(
            ...
            if (active_tab.value == 1) {
              ...
              if (((_a = selected_employee.value) == null ? void 0 : _a.id) > 0) {
                _push2(`<div class="d-flex align-items-center mt-1"${_scopeId}><span class="badge bg-primary-subtle text-primary border border-primary-subtle px-3 py-2 rounded-pill fw-bold"${_scopeId}>${ssrInterpolate(((_b = selected_employee.value.roles) == null ? void 0 : _b.name) || "-")}</span>`);
                if (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) {
                  _push2(`<a${ssrRenderAttr("href", "/seeo/staff/ceo/panel")} class="btn btn-sm btn-link text-decoration-none ms-auto" title="Manage in CEO Panel"${_scopeId}><i class="bi bi-gear-fill me-1"${_scopeId}></i> CEO Panel </a>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              ...
              _push2(`</div></div>`);
              if ((unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && selected_employee.value.id > 0) {
            ...
            _push2(`</div><div class="col-lg-6"${_scopeId}>`);
            if (active_tab.value == 1) {
              _push2(`<div class="row mb-3"${_scopeId}><div class="col-12"${_scopeId}><div class="card shadow-sm p-3"${_scopeId}><div class="row"${_scopeId}><div class="col-12"${_scopeId}><div class="d-flex pb-2"${_scopeId}><span class="text-primary-emphasis me-auto my-auto h6"${_scopeId}><i class="bi bi-people me-1"${_scopeId}></i> ${ssrInterpolate("Staff List")}</span></div></div></div><div class="d-flex mt-2"${_scopeId}><span class="text-primary pe-3 me-3 my-auto"${_scopeId}>${ssrInterpolate("Filter")}</span><button class="btn text-nowrap btn-sm btn-outline-secondary border rounded-2 border-secondary-subtle py-0"${_scopeId}>${ssrInterpolate("Name")} <i class="${ssrRenderClass(
                "bi bi-arrow-" + (__props.filter.staff.category == "name" ? __props.filter.staff.order == "asc" ? "up" : "down" : "up")
              )}"${_scopeId}></i></button><button class="btn text-nowrap btn-sm btn-outline-secondary border rounded-2 border-secondary-subtle py-0 ms-2"${_scopeId}>${ssrInterpolate("Role")} <i class="${ssrRenderClass(
              ...
              if (__props.employees.length > 0) {
                ...
                ssrRenderList(__props.employees, (employee) => {
                  ...
                  )}"${_scopeId}><span class="d-flex"${_scopeId}><span class="me-2 text-secondary fw-normal pe-2"${_scopeId}>${ssrInterpolate(__props.employees.indexOf(
                    employee
                  ) + 1)}</span><span class="${ssrRenderClass(
                    "scroll-x-hidden me-2 " + (employee.id == selected_employee.value.id ? "text-primary" : "text-dark")
                  )}"${_scopeId}><span class="text-nowrap"${_scopeId}>${ssrInterpolate(employee.name)}</span></span><span class="ms-auto text-secondary scroll-x-hidden"${_scopeId}><span class="text-nowrap"${_scopeId}>${ssrInterpolate(((_a2 = employee.roles) == null ? void 0 : _a2.name) || "")}</span></span></span></ul>`);
                });
                _push2(`<!--]-->`);
              } else {
                _push2(`<!---->`);
            ...
            if (active_tab.value == 2) {
              _push2(`<div class="row mb-3"${_scopeId}><div class="col-12"${_scopeId}><div class="card shadow-sm p-3"${_scopeId}><div class="row"${_scopeId}><div class="col-12"${_scopeId}><div class="d-flex pb-2"${_scopeId}><span class="text-primary-emphasis me-auto my-auto h6"${_scopeId}><i class="bi bi-people me-1"${_scopeId}></i><span class="d-none d-lg-inline"${_scopeId}>${ssrInterpolate("Employee ")}</span> ${ssrInterpolate("List")}</span></div></div></div><div class="d-flex mt-2"${_scopeId}><span class="text-primary pe-3 me-3 my-auto"${_scopeId}>${ssrInterpolate("Filter")}</span><button class="btn text-nowrap btn-sm btn-outline-secondary border rounded-2 border-secondary-subtle py-0"${_scopeId}>${ssrInterpolate("Name")} <i class="${ssrRenderClass(
              ...
              if (__props.unemployees.length > 0) {
                ...
                ssrRenderList(__props.unemployees, (employee) => {
                  ...
                  )}"${_scopeId}><span class="d-flex"${_scopeId}><span class="mx-2 text-secondary pe-2"${_scopeId}>${ssrInterpolate(__props.unemployees.indexOf(
                    employee
                  ) + 1)}</span><span class="${ssrRenderClass(
                            ...
                            createVNode("div", { class: "col-12" }, [
                              createVNode("div", { class: "card border-0 shadow-sm p-3" }, [
                                createVNode("div", { class: "row" }, [
                                  createVNode("div", { class: "col-12" }, [
                                    createVNode("div", { class: "card border-0 rounded-0 rounded-top d-flex" }, [
                                ...
                                createVNode("div", { class: "row g-2 mt-2" }, [
                                  createVNode("div", { class: "col-12 col-lg-6" }, [
                                    ...
                                    createVNode("a", {
                                      href: selected_employee.value.id > 0 ? `/seeo/staff/profile/${selected_employee.value.id}` : "",
                                  ...
                                  createVNode("div", { class: "col-12 col-lg-6" }, [
                                    ...
                                    ((_a2 = selected_employee.value) == null ? void 0 : _a2.id) > 0 ? (openBlock(), createBlock("div", {
                                      key: 0,
                                      class: "d-flex align-items-center mt-1"
                                    }, [
                                      createVNode("span", { class: "badge bg-primary-subtle text-primary border border-primary-subtle px-3 py-2 rounded-pill fw-bold" }, toDisplayString(((_b2 = selected_employee.value.roles) == null ? void 0 : _b2.name) || "-"), 1),
                                      unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99 ? (openBlock(), createBlock("a", {
                                        key: 0,
                                        href: "/seeo/staff/ceo/panel",
                                        class: "btn btn-sm btn-link text-decoration-none ms-auto",
                                        title: "Manage in CEO Panel"
                                      }, [
                                        createVNode("i", { class: "bi bi-gear-fill me-1" }),
                                        createTextVNode(" CEO Panel ")
                                      ])) : createCommentVNode("", true)
                                    ])) : createCommentVNode("", true)
                                  ])
                                ]),
                                (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && selected_employee.value.id > 0 ? (openBlock(), createBlock("div", {
                                  key: 0,
                                  class: "d-flex mt-2"
                                }, [
                                  createVNode("button", {
                                    onClick: ($event) => confirmation(
                                      `/seeo/staff/user/role/remove/${selected_employee.value.id}`,
                          ...
                          active_tab.value == 2 ? (openBlock(), createBlock("div", {
                            ...
                            createVNode("div", { class: "col-12" }, [
                              createVNode("div", { class: "card border-0 shadow-sm p-3" }, [
                                ...
                                (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) && ((_a2 = selected_customer.value) == null ? void 0 : _a2.id) > 0 ? (openBlock(), createBlock("div", {
                                  key: 0,
                                  class: "alert alert-info mt-3 mb-0 py-2 border-0 shadow-none d-flex align-items-center"
                                }, [
                                  createVNode("i", { class: "bi bi-info-circle-fill me-2" }),
                                  createVNode("small", null, [
                                    createTextVNode("Gunakan "),
                                    createVNode("b", null, "CEO Panel"),
                                    createTextVNode(" untuk merekrut staff baru.")
                                  ]),
                                  createVNode("a", {
                                    href: "/seeo/staff/ceo/panel",
                                  ...
                                  __props.employees.length > 0 ? (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(__props.employees, (employee) => {
                                    ...
                                    return openBlock(), createBlock("ul", {
                                      ...
                                      createVNode("span", {
                                        ...
                                        createVNode("span", { class: "me-2 text-secondary fw-normal pe-2" }, toDisplayString(__props.employees.indexOf(
                                          employee
                                        ) + 1), 1),
                                        createVNode("span", {
                                        ...
                                        createVNode("span", { class: "ms-auto text-secondary scroll-x-hidden" }, [
                                          createVNode("span", { class: "text-nowrap" }, toDisplayString(((_a2 = employee.roles) == null ? void 0 : _a2.name) || ""), 1)
                                        ])
                                      ], 8, ["onClick"])
                                    ], 2);
                                  ...
                                  __props.unemployees.length > 0 ? (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(__props.unemployees, (employee) => {
                                    return openBlock(), createBlock("ul", {
                                      ...
                                      createVNode("span", { class: "d-flex" }, [
                                        createVNode("span", { class: "mx-2 text-secondary pe-2" }, toDisplayString(__props.unemployees.indexOf(
                                          employee
                                        ) + 1), 1),
                                        createVNode("span", {
...
//# sourceMappingURL=Employee-DOyI5cwq.js.map
