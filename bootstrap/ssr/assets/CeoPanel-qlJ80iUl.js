import { ref, computed, resolveComponent, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, withDirectives, createTextVNode, toDisplayString, vModelText, Fragment, renderList, vShow, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(StaffLayout, mergeProps({ page_title: "CEO Panel" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="ceo-panel" data-v-178ae40f${_scopeId}><div class="panel-header" data-v-178ae40f${_scopeId}><div data-v-178ae40f${_scopeId}><h1 class="panel-title" data-v-178ae40f${_scopeId}><i class="bi bi-award-fill me-2" data-v-178ae40f${_scopeId}></i>CEO Panel</h1><p class="panel-sub" data-v-178ae40f${_scopeId}>Kelola kepengurusan tahunan &amp; manajemen staff</p></div>`);
            if (__props.activeYear) {
              _push2(`<div class="active-year-badge" data-v-178ae40f${_scopeId}><i class="bi bi-calendar-check-fill" data-v-178ae40f${_scopeId}></i> Aktif: ${ssrInterpolate(__props.activeYear.label || __props.activeYear.year)}</div>`);
            } else {
              _push2(`<div class="active-year-badge inactive" data-v-178ae40f${_scopeId}><i class="bi bi-exclamation-triangle-fill" data-v-178ae40f${_scopeId}></i> Belum ada tahun aktif </div>`);
            }
            _push2(`</div><div class="tab-bar" data-v-178ae40f${_scopeId}><button class="${ssrRenderClass(["tab-btn", { active: tab.value === "years" }])}" data-v-178ae40f${_scopeId}><i class="bi bi-calendar3" data-v-178ae40f${_scopeId}></i> Tahun Kepengurusan </button><button class="${ssrRenderClass(["tab-btn", { active: tab.value === "staff" }])}" data-v-178ae40f${_scopeId}><i class="bi bi-people-fill" data-v-178ae40f${_scopeId}></i> Manajemen Staff <span class="badge" data-v-178ae40f${_scopeId}>${ssrInterpolate(__props.staff.length)}</span></button><button class="${ssrRenderClass(["tab-btn", { active: tab.value === "recruit" }])}" data-v-178ae40f${_scopeId}><i class="bi bi-person-plus-fill" data-v-178ae40f${_scopeId}></i> Rekrut Staff <span class="badge" data-v-178ae40f${_scopeId}>${ssrInterpolate(__props.nonStaff.length)}</span></button></div><div style="${ssrRenderStyle(tab.value === "years" ? null : { display: "none" })}" class="tab-content" data-v-178ae40f${_scopeId}><div class="card-block" data-v-178ae40f${_scopeId}><h3 class="block-title" data-v-178ae40f${_scopeId}><i class="bi bi-plus-circle-fill" data-v-178ae40f${_scopeId}></i> Tambah Tahun Kepengurusan</h3><div class="form-row" data-v-178ae40f${_scopeId}><div class="form-group" data-v-178ae40f${_scopeId}><label data-v-178ae40f${_scopeId}>Tahun</label><input type="number"${ssrRenderAttr("value", newYear.value)} min="2000" max="2099" class="form-ctrl" data-v-178ae40f${_scopeId}></div><div class="form-group flex-2" data-v-178ae40f${_scopeId}><label data-v-178ae40f${_scopeId}>Label (opsional)</label><input type="text"${ssrRenderAttr("value", newLabel.value)} placeholder="cth: Kepengurusan 2026/2027" class="form-ctrl" data-v-178ae40f${_scopeId}></div><div class="form-group align-end" data-v-178ae40f${_scopeId}><button class="btn-primary" data-v-178ae40f${_scopeId}><i class="bi bi-plus" data-v-178ae40f${_scopeId}></i> Tambah </button></div></div>`);
            if ((_a = __props.errors) == null ? void 0 : _a.year) {
              _push2(`<p class="err-msg" data-v-178ae40f${_scopeId}>${ssrInterpolate(__props.errors.year[0])}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="card-block" data-v-178ae40f${_scopeId}><h3 class="block-title" data-v-178ae40f${_scopeId}><i class="bi bi-list-ul" data-v-178ae40f${_scopeId}></i> Daftar Tahun Kepengurusan</h3>`);
            if (__props.governanceYears.length === 0) {
              _push2(`<div class="empty-state" data-v-178ae40f${_scopeId}> Belum ada tahun kepengurusan. Tambahkan di atas. </div>`);
            } else {
              _push2(`<div class="year-list" data-v-178ae40f${_scopeId}><!--[-->`);
              ssrRenderList(__props.governanceYears, (gy) => {
                var _a2;
                _push2(`<div class="${ssrRenderClass(["year-card", { "year-active": gy.is_active }])}" data-v-178ae40f${_scopeId}><div class="year-info" data-v-178ae40f${_scopeId}><span class="year-number" data-v-178ae40f${_scopeId}>${ssrInterpolate(gy.year)}</span><span class="year-label" data-v-178ae40f${_scopeId}>${ssrInterpolate(gy.label || "—")}</span>`);
                if (gy.is_active) {
                  _push2(`<span class="badge-active" data-v-178ae40f${_scopeId}>AKTIF</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
                if (gy.activated_by && gy.is_active) {
                  _push2(`<div class="year-meta" data-v-178ae40f${_scopeId}> Diaktifkan oleh ${ssrInterpolate(((_a2 = gy.activated_by) == null ? void 0 : _a2.name) || "—")} ${ssrInterpolate(gy.activated_at ? "pada " + new Date(gy.activated_at).toLocaleDateString("id-ID") : "")}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="year-actions" data-v-178ae40f${_scopeId}><button class="${ssrRenderClass(["toggle-switch", { "toggle-on": gy.is_active }])}"${ssrRenderAttr("title", gy.is_active ? "Klik untuk nonaktifkan" : "Klik untuk aktifkan")} data-v-178ae40f${_scopeId}><span class="toggle-knob" data-v-178ae40f${_scopeId}></span></button><span class="${ssrRenderClass([{ "toggle-label-on": gy.is_active }, "toggle-label"])}" data-v-178ae40f${_scopeId}>${ssrInterpolate(gy.is_active ? "Aktif" : "Nonaktif")}</span></div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div></div><div style="${ssrRenderStyle(tab.value === "staff" ? null : { display: "none" })}" class="tab-content" data-v-178ae40f${_scopeId}><div class="card-block" data-v-178ae40f${_scopeId}><div class="block-header" data-v-178ae40f${_scopeId}><h3 class="block-title" data-v-178ae40f${_scopeId}><i class="bi bi-people-fill" data-v-178ae40f${_scopeId}></i> Daftar Staff</h3><input type="text"${ssrRenderAttr("value", staffSearch.value)} placeholder="Cari nama / email..." class="form-ctrl search-ctrl" data-v-178ae40f${_scopeId}></div>`);
            if (filteredStaff.value.length === 0) {
              _push2(`<div class="empty-state" data-v-178ae40f${_scopeId}> Tidak ada staff ditemukan. </div>`);
            } else {
              _push2(`<div class="staff-table-wrap" data-v-178ae40f${_scopeId}><table class="staff-table" data-v-178ae40f${_scopeId}><thead data-v-178ae40f${_scopeId}><tr data-v-178ae40f${_scopeId}><th data-v-178ae40f${_scopeId}>Nama</th><th data-v-178ae40f${_scopeId}>Email</th><th data-v-178ae40f${_scopeId}>Role Saat Ini</th><th data-v-178ae40f${_scopeId}>Ubah Role</th><th data-v-178ae40f${_scopeId}>Aksi</th></tr></thead><tbody data-v-178ae40f${_scopeId}><!--[-->`);
              ssrRenderList(filteredStaff.value, (user) => {
                var _a2;
                _push2(`<tr data-v-178ae40f${_scopeId}><td data-v-178ae40f${_scopeId}><div class="user-name" data-v-178ae40f${_scopeId}>${ssrInterpolate(user.name)}</div></td><td class="text-muted" data-v-178ae40f${_scopeId}>${ssrInterpolate(user.email)}</td><td data-v-178ae40f${_scopeId}><span class="role-chip" data-v-178ae40f${_scopeId}>${ssrInterpolate(((_a2 = user.roles) == null ? void 0 : _a2.name) || "Role #" + user.roles_id)}</span></td><td data-v-178ae40f${_scopeId}><select${ssrRenderAttr("value", getRoleValue(user))} class="form-ctrl-sm" data-v-178ae40f${_scopeId}><!--[-->`);
                ssrRenderList(__props.roles, (r) => {
                  _push2(`<option${ssrRenderAttr("value", r.id)} data-v-178ae40f${_scopeId}> [${ssrInterpolate(r.id)}] ${ssrInterpolate(r.name)}</option>`);
                });
                _push2(`<!--]--></select></td><td class="actions-cell" data-v-178ae40f${_scopeId}><button class="btn-sm-primary" title="Simpan role" data-v-178ae40f${_scopeId}><i class="bi bi-check2" data-v-178ae40f${_scopeId}></i> Simpan </button><button class="btn-sm-danger" title="Keluarkan dari staff" data-v-178ae40f${_scopeId}><i class="bi bi-person-dash" data-v-178ae40f${_scopeId}></i></button></td></tr>`);
              });
              _push2(`<!--]--></tbody></table></div>`);
            }
            _push2(`</div></div><div style="${ssrRenderStyle(tab.value === "recruit" ? null : { display: "none" })}" class="tab-content" data-v-178ae40f${_scopeId}><div class="card-block" data-v-178ae40f${_scopeId}><div class="block-header" data-v-178ae40f${_scopeId}><h3 class="block-title" data-v-178ae40f${_scopeId}><i class="bi bi-person-plus-fill" data-v-178ae40f${_scopeId}></i> User Terdaftar (Belum Staff)</h3><input type="text"${ssrRenderAttr("value", nonStaffSearch.value)} placeholder="Cari nama / email..." class="form-ctrl search-ctrl" data-v-178ae40f${_scopeId}></div>`);
            if (filteredNonStaff.value.length === 0) {
              _push2(`<div class="empty-state" data-v-178ae40f${_scopeId}> Semua user sudah menjadi staff, atau belum ada yang mendaftar. </div>`);
            } else {
              _push2(`<div class="staff-table-wrap" data-v-178ae40f${_scopeId}><table class="staff-table" data-v-178ae40f${_scopeId}><thead data-v-178ae40f${_scopeId}><tr data-v-178ae40f${_scopeId}><th data-v-178ae40f${_scopeId}>Nama</th><th data-v-178ae40f${_scopeId}>Email</th><th data-v-178ae40f${_scopeId}>Bergabung</th><th data-v-178ae40f${_scopeId}>Aksi</th></tr></thead><tbody data-v-178ae40f${_scopeId}><!--[-->`);
              ssrRenderList(filteredNonStaff.value, (user) => {
                _push2(`<tr data-v-178ae40f${_scopeId}><td data-v-178ae40f${_scopeId}><div class="user-name" data-v-178ae40f${_scopeId}>${ssrInterpolate(user.name)}</div></td><td class="text-muted" data-v-178ae40f${_scopeId}>${ssrInterpolate(user.email)}</td><td class="text-muted" data-v-178ae40f${_scopeId}>${ssrInterpolate(new Date(user.created_at).toLocaleDateString("id-ID"))}</td><td data-v-178ae40f${_scopeId}><button class="btn-sm-primary" data-v-178ae40f${_scopeId}><i class="bi bi-person-plus" data-v-178ae40f${_scopeId}></i> Jadikan Staff </button></td></tr>`);
              });
              _push2(`<!--]--></tbody></table></div>`);
            }
            _push2(`</div></div></div>`);
...
const CeoPanel = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-178ae40f"]]);
export {
  CeoPanel as default
};
//# sourceMappingURL=CeoPanel-qlJ80iUl.js.map
