...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form_contribution_setting = useForm({
      ...
      start: ((_b = props.contribution_config) == null ? void 0 : _b.financial_id) > 0 ? props.contribution_config.start : (/* @__PURE__ */ new Date()).getMonth() + 1,
      end: ((_c = props.contribution_config) == null ? void 0 : _c.financial_id) > 0 ? props.contribution_config.period + props.contribution_config.start - 1 : (/* @__PURE__ */ new Date()).getMonth() + 1
    });
...
//# sourceMappingURL=FinanceFeature-DVO5V3FV.js.map
