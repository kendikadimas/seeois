import { computed, ref, onMounted, nextTick, onUnmounted, watch, withCtx, unref, createVNode, Transition, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString, withModifiers, withDirectives, vModelText, Fragment, renderList, vModelSelect, useSSRContext } from "vue";
...
import { g as getMonthName, f as formatIDR, s as showImage } from "./utils-DIF4pdrF.js";
          ...
          if (_push2) {
            ...
            if (auth_user.value.roles_id == 99 || auth_user.value.id == __props.profile.id) {
              ...
              if (activeTab.value == 2 || isLargeScreen.value) {
                ...
                _push2(`<div class="mt-2"${_scopeId}><div class="d-flex"${_scopeId}><button class="btn btn-sm border-0 ms-auto text-primary text-decoration-none p-0" style="${ssrRenderStyle({ "font-size": "0.7rem" })}" data-bs-toggle="collapse" data-bs-target="#programListCollapse"${_scopeId}>${ssrInterpolate(auth_user.value.id == __props.profile.id ? "check my logbook" : "check logbook")}</button></div><div class="collapse" id="programListCollapse"${_scopeId}><!--[-->`);
                ssrRenderList(__props.program_list, (program) => {
                  var _a2;
                  _push2(`<a${ssrRenderAttr(
                    "href",
                    `/seeo/staff/program/${program.program_id}/logbook/${__props.profile.id}`
                            ...
                            activeTab.value == 2 || isLargeScreen.value ? (openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "mt-2" }, [
                                createVNode("div", { class: "d-flex" }, [
                                  ...
                                  }, toDisplayString(auth_user.value.id == __props.profile.id ? "check my logbook" : "check logbook"), 1)
                                ]),
                                createVNode("div", {
                                  class: "collapse",
...
//# sourceMappingURL=Profile-DcekuxoR.js.map
