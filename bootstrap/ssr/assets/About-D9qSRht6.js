            ...
            return [
              createVNode("section", { class: "pt-32 pb-20 bg-white overflow-hidden relative" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-6 relative z-10 text-center" }, [
                  ...
                  createVNode("p", { class: "text-gray-500 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed" }, " Student Entrepreneur and Empowerment Organization (SEEO) adalah Unit Kegiatan Mahasiswa resmi di lingkungan Fakultas Teknik Universitas Jenderal Soedirman. ")
                ]),
...
//# sourceMappingURL=About-D9qSRht6.js.map
