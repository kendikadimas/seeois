import { mergeProps, withCtx, openBlock, createBlock, createVNode, createTextVNode, toDisplayString, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "certificates-container" }, _attrs))} data-v-04ae75ff>`);
      _push(ssrRenderComponent(StaffLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (_ctx.$page.props.flash.success) {
              _push2(`<div class="alert alert-success-custom" role="alert" data-v-04ae75ff${_scopeId}><i class="bi bi-check-circle-fill" data-v-04ae75ff${_scopeId}></i><div class="alert-content" data-v-04ae75ff${_scopeId}><strong data-v-04ae75ff${_scopeId}>Sukses!</strong> ${ssrInterpolate(_ctx.$page.props.flash.success)}</div><button type="button" class="alert-close" data-v-04ae75ff${_scopeId}><i class="bi bi-x" data-v-04ae75ff${_scopeId}></i></button></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (_ctx.$page.props.flash.error) {
              _push2(`<div class="alert alert-danger-custom" role="alert" data-v-04ae75ff${_scopeId}><i class="bi bi-exclamation-circle-fill" data-v-04ae75ff${_scopeId}></i><div class="alert-content" data-v-04ae75ff${_scopeId}><strong data-v-04ae75ff${_scopeId}>Error!</strong> ${ssrInterpolate(_ctx.$page.props.flash.error)}</div><button type="button" class="alert-close" data-v-04ae75ff${_scopeId}><i class="bi bi-x" data-v-04ae75ff${_scopeId}></i></button></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (!__props.certs || __props.certs.length === 0) {
              _push2(`<div class="empty-state-container" data-v-04ae75ff${_scopeId}><div class="empty-state" data-v-04ae75ff${_scopeId}><div class="empty-icon" data-v-04ae75ff${_scopeId}><i class="bi bi-inbox" data-v-04ae75ff${_scopeId}></i></div><h3 class="empty-title" data-v-04ae75ff${_scopeId}>Belum Ada Sertifikat</h3><p class="empty-text" data-v-04ae75ff${_scopeId}> Anda belum memiliki sertifikat Internship yang dipublikasikan. <br data-v-04ae75ff${_scopeId}> Hubungi HR Manager untuk mendapatkan sertifikat Anda. </p></div></div>`);
            } else {
              _push2(`<div class="certificates-content" data-v-04ae75ff${_scopeId}><div class="congrats-section" data-v-04ae75ff${_scopeId}><div class="congrats-content" data-v-04ae75ff${_scopeId}><h2 class="congrats-title" data-v-04ae75ff${_scopeId}>Selamat! 🎉</h2><p class="congrats-message" data-v-04ae75ff${_scopeId}> Anda telah berhasil menyelesaikan program Internship di <strong data-v-04ae75ff${_scopeId}>SEEO</strong>. Terima kasih atas dedikasi dan kontribusi Anda selama masa Internship. Pengalaman dan pembelajaran yang Anda dapatkan di sini semoga menjadi bekal berharga untuk perjalanan karir Anda ke depan. </p></div><!--[-->`);
              ssrRenderList(__props.certs, (cert) => {
                _push2(`<div class="cert-download-wrapper" data-v-04ae75ff${_scopeId}><button class="btn-download-certificate" title="Unduh Sertifikat PDF" data-v-04ae75ff${_scopeId}><i class="bi bi-download" data-v-04ae75ff${_scopeId}></i><span data-v-04ae75ff${_scopeId}>Unduh Sertifikat Internship</span></button></div>`);
              });
              _push2(`<!--]--></div><div class="invitation-section" data-v-04ae75ff${_scopeId}><div class="invitation-card" data-v-04ae75ff${_scopeId}><div class="invitation-icon" data-v-04ae75ff${_scopeId}><i class="bi bi-people-fill" data-v-04ae75ff${_scopeId}></i></div><h3 class="invitation-title" data-v-04ae75ff${_scopeId}>Bergabung dengan Tim SEEO</h3><p class="invitation-text" data-v-04ae75ff${_scopeId}> Kami mengundang Anda untuk menjadi bagian dari kepengurusan SEEO periode selanjutnya. Mari bersama-sama membangun ekosistem entrepreneurship yang lebih kuat dan berdampak positif bagi mahasiswa Fakultas Teknik UNSOED. </p><div class="invitation-features" data-v-04ae75ff${_scopeId}><div class="feature-item" data-v-04ae75ff${_scopeId}><i class="bi bi-check-circle-fill" data-v-04ae75ff${_scopeId}></i><span data-v-04ae75ff${_scopeId}>Kembangkan skill leadership &amp; teamwork</span></div><div class="feature-item" data-v-04ae75ff${_scopeId}><i class="bi bi-check-circle-fill" data-v-04ae75ff${_scopeId}></i><span data-v-04ae75ff${_scopeId}>Perluas networking &amp; relasi</span></div><div class="feature-item" data-v-04ae75ff${_scopeId}><i class="bi bi-check-circle-fill" data-v-04ae75ff${_scopeId}></i><span data-v-04ae75ff${_scopeId}>Berkontribusi dalam program-program inovatif</span></div></div></div></div></div>`);
            }
          } else {
            return [
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-04ae75ff"]]);
export {
  Index as default
};
//# sourceMappingURL=Index-CLxQZmSQ.js.map
