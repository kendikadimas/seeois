import { ref, computed, onMounted, onUnmounted, watch, withCtx, unref, createVNode, toDisplayString, Transition, openBlock, createBlock, createCommentVNode, createTextVNode, Fragment, renderList, withDirectives, vModelSelect, vModelText, withModifiers, vModelCheckbox, useSSRContext } from "vue";
...
import { f as formatIDR, g as getMonthName, a as formatDate } from "./utils-DIF4pdrF.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const selected_contribution_id = ref(
      props.default_contribution_id && props.default_contribution_id > 0 ? props.default_contribution_id : null
    );
    ...
    const form_contribution_setting = useForm({
      ...
      start: ((_b = props.contribution_config) == null ? void 0 : _b.financial_id) > 0 ? props.contribution_config.start : 4,
      end: ((_c = props.contribution_config) == null ? void 0 : _c.financial_id) > 0 ? props.contribution_config.period + props.contribution_config.start - 1 : 12
    });
          ...
          if (_push2) {
            ...
            if (contribution_configuration_collapse.value) {
              ...
              if (active_tab.value == 1 || isLargeScreen.value) {
                _push2(`<div${_scopeId}><div class="row gx-2"${_scopeId}><div class="col-2 d-none d-lg-block"${_scopeId}><div class="d-flex h-100"${_scopeId}><span class="text-primary my-auto"${_scopeId}>${ssrInterpolate("Contribution")}</span></div></div><div class="col-lg-10 col-12"${_scopeId}><div class="row g-2"${_scopeId}><div class="col-6 col-lg-3"${_scopeId}><span class="text-secondary d-block" style="${ssrRenderStyle("font-size: 0.8rem;")}"${_scopeId}>${ssrInterpolate("Charge")}</span><span class="text-dark"${_scopeId}>${ssrInterpolate(unref(formatIDR)(
                ...
                ))}</span></div><div class="col-6 col-lg-3"${_scopeId}><span class="text-secondary d-block" style="${ssrRenderStyle("font-size: 0.8rem;")}"${_scopeId}>${ssrInterpolate("Period")}</span><span class="text-dark"${_scopeId}>${ssrInterpolate(unref(getMonthName)((__props.contribution_config.start - 1) % 12 + 1) + " - " + unref(getMonthName)((__props.contribution_config.start + __props.contribution_config.period - 2) % 12 + 1))}</span></div><div class="col-6 col-lg-3"${_scopeId}><span class="text-secondary d-block" style="${ssrRenderStyle("font-size: 0.8rem;")}"${_scopeId}>${ssrInterpolate("Total")}</span><span class="text-dark"${_scopeId}>${ssrInterpolate(unref(formatIDR)(
                  ...
                  "href",
                  `/seeo/staff/profile/${__props.contribution_config.financial_id}`
              ...
              if (active_tab.value == 2 || isLargeScreen.value) {
                ...
                if (__props.payroll_balance.financial_id > 0) {
                  _push2(`<a${ssrRenderAttr(
                    "href",
                    `/seeo/staff/profile/${(_a2 = __props.payroll_balance) == null ? void 0 : _a2.financial_id}`
            ...
            _push2(`<div class="card rounded-top-0"${_scopeId}><div class="row g-2 mt-2"${_scopeId}><div class="col-12 col-lg-3"${_scopeId}><span class="text-secondary d-block" style="${ssrRenderStyle("font-size: 0.8rem;")}"${_scopeId}>${ssrInterpolate("Staff")}</span><a${ssrRenderAttr(
              "href",
              ((_d = selected_contribution.value) == null ? void 0 : _d.id) > 0 ? `/seeo/staff/profile/${(_e = selected_contribution.value) == null ? void 0 : _e.id}` : ""
            ...
            if (active_tab.value == 1 || isLargeScreen.value) {
              ...
              ssrRenderList(__props.contribution_config.period, (month) => {
                ...
                _push2(`<div class="${ssrRenderClass(
                  ...
                  (month + __props.contribution_config.start - 2) % 12 + 1,
                  "short"
                ))}</span></div>`);
              });
              ...
              if (selected_receipt_id.value) {
                _push2(`<div class="col-12"${_scopeId}><div class="card mt-2 bg-light"${_scopeId}><div class="row mt-2"${_scopeId}><div class="col-12 d-flex"${_scopeId}><a${ssrRenderAttr(
                  "href",
                  "/storage/local/images/receipt/contribution/" + selected_receipt.value.receipt
            ...
            if (selected_receipt_id.value == null) {
              _push2(`<div class="card sm p-3"${_scopeId}><div class="row"${_scopeId}><div class="col-12"${_scopeId}><div class="d-flex pb-2"${_scopeId}><span class="text-primary-emphasis me-auto my-auto h6"${_scopeId}><i class="bi bi-people me-1"${_scopeId}></i> ${ssrInterpolate("Staff List")}</span></div></div></div><div class="d-flex mt-2"${_scopeId}>`);
                ...
                createVNode("div", { class: "row gx-4 mt-4" }, [
                  createVNode("div", { class: "col-12" }, [
                    createVNode("div", { class: "card p-3 shadow-sm bg-white" }, [
                                    ...
                                    createVNode("div", { class: "col-lg-10 col-12" }, [
                                      createVNode("div", { class: "row g-2" }, [
                                        ...
                                        createVNode("div", { class: "col-6 col-lg-3" }, [
                                          ...
                                          createVNode("span", { class: "text-dark" }, toDisplayString(unref(getMonthName)((__props.contribution_config.start - 1) % 12 + 1) + " - " + unref(getMonthName)((__props.contribution_config.start + __props.contribution_config.period - 2) % 12 + 1)), 1)
                                        ]),
                                        createVNode("div", { class: "col-6 col-lg-3" }, [
                                          createVNode("span", {
                                            class: "text-secondary d-block",
                                        ...
                                        createVNode("div", { class: "col-6 col-lg-3" }, [
                                          ...
                                          createVNode("a", {
                                            href: `/seeo/staff/profile/${__props.contribution_config.financial_id}`,
                                            ...
                                            createVNode("div", { class: "row g-2" }, [
                                              ...
                                              createVNode("div", { class: "col-6 col-lg-12" }, [
                                                ...
                                                __props.payroll_balance.financial_id > 0 ? (openBlock(), createBlock("a", {
                                                  key: 0,
                                                  href: `/seeo/staff/profile/${(_a3 = __props.payroll_balance) == null ? void 0 : _a3.financial_id}`,
                                                  class: "text-dark text-decoration-none d-flex"
                                                }, [
                      ...
                      createVNode("div", { class: "card rounded-top-0" }, [
                        createVNode("div", { class: "row g-2 mt-2" }, [
                          createVNode("div", { class: "col-12 col-lg-3" }, [
                            ...
                            createVNode("a", {
                              href: ((_y = selected_contribution.value) == null ? void 0 : _y.id) > 0 ? `/seeo/staff/profile/${(_z = selected_contribution.value) == null ? void 0 : _z.id}` : "",
                                              ...
                                              createVNode("div", { class: "card mt-2 bg-light" }, [
                                                createVNode("div", { class: "row mt-2" }, [
                                                  createVNode("div", { class: "col-12 d-flex" }, [
                                                    createVNode("a", {
                                                      href: "/storage/local/images/receipt/contribution/" + selected_receipt.value.receipt,
                                                      ...
                                                      createVNode(Transition, {
                                                        ...
                                                        default: withCtx(() => [
                                                          (openBlock(), createBlock("img", {
                                                            ...
                                                            src: "/storage/local/images/receipt/contribution/" + selected_receipt.value.receipt,
                                                            class: "w-100 rounded",
                                                            alt: "image"
                                                          }, null, 8, ["src"]))
                                                        ]),
                                                        ...
                                                        default: withCtx(() => [
                                                          createVNode("button", {
                                                            onClick: ($event) => confirmation(
                                                              `/seeo/staff/contribution/validation/${selected_receipt.value.id}`,
...
//# sourceMappingURL=FinanceFeature-DJWuMJWA.js.map
