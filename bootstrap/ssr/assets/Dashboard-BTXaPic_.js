      ...
      _push(ssrRenderComponent(StaffLayout, _attrs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="container-fluid g-0" data-v-621375d3${_scopeId}><div class="row g-0 vh-100 overflow-hidden" data-v-621375d3${_scopeId}><div class="col-12 d-flex flex-column bg-light overflow-hidden" data-v-621375d3${_scopeId}><main class="dashboard-content flex-grow-1 overflow-auto p-2 p-lg-3" data-v-621375d3${_scopeId}><div class="row gx-2 gy-3 gy-lg-3 gx-lg-3" data-v-621375d3${_scopeId}><div class="col-12 col-lg-9 d-flex flex-column" data-v-621375d3${_scopeId}><div class="card shadow-sm mb-2 mb-lg-3 flex-shrink-0 rounded-3 border-0" data-v-621375d3${_scopeId}><div class="card-body p-0 position-relative rounded-3 overflow-hidden" data-v-621375d3${_scopeId}>`);
            if (!__props.billboard_list || __props.billboard_list.length === 0) {
              _push2(`<div class="empty-billboard d-flex align-items-center justify-content-center p-4" style="${ssrRenderStyle({ "min-height": "200px", "max-height": "360px", "background-color": "#e9ecef" })}" data-v-621375d3${_scopeId}>`);
              if (unref(auth_user).roles_id === 1) {
                _push2(`<button class="btn btn-primary btn-lg" data-v-621375d3${_scopeId}><i class="bi bi-plus-circle me-2" data-v-621375d3${_scopeId}></i> <span data-v-621375d3${_scopeId}>Tambah Billboard</span></button>`);
              } else {
                _push2(`<span class="text-muted fs-5" data-v-621375d3${_scopeId}>Selamat Datang!</span>`);
              }
              _push2(`</div>`);
            } else {
              _push2(`<div id="billboardCarousel" class="carousel slide" data-bs-ride="carousel" style="${ssrRenderStyle({ "max-height": "360px" })}" data-v-621375d3${_scopeId}>`);
              if (unref(auth_user).roles_id === 1) {
                _push2(`<div class="position-absolute top-0 end-0 p-2" style="${ssrRenderStyle({ "z-index": "20" })}" data-v-621375d3${_scopeId}><button class="btn btn-sm btn-light me-1" title="Tambah Billboard Baru" data-v-621375d3${_scopeId}><i class="bi bi-plus-lg" data-v-621375d3${_scopeId}></i></button></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="carousel-inner rounded-3" data-v-621375d3${_scopeId}><!--[-->`);
              ssrRenderList(__props.billboard_list, (billboard, index) => {
                _push2(`<div class="${ssrRenderClass(["carousel-item", index === 0 ? "active" : ""])}" data-v-621375d3${_scopeId}><div class="billboard-wrapper position-relative" data-v-621375d3${_scopeId}>`);
                if (unref(auth_user).roles_id == 1) {
                  _push2(`<button class="btn btn-danger btn-sm rounded-circle p-0 lh-1 position-absolute m-2" style="${ssrRenderStyle({ "z-index": "11", "width": "28px", "height": "28px", "top": "0.35rem", "right": "3rem" })}" data-v-621375d3${_scopeId}><i class="bi bi-x-lg small" data-v-621375d3${_scopeId}></i></button>`);
                } else {
                  _push2(`<!---->`);
                }
                if (billboard.image && setBillboardImage(billboard.image)) {
                  _push2(`<img${ssrRenderAttr("src", setBillboardImage(billboard.image))} alt="Billboard" data-v-621375d3${_scopeId}>`);
                } else if (!billboard.image && billboard.text) {
                  _push2(`<div class="d-flex flex-column justify-content-center align-items-center text-center p-4 bg-light w-100 h-100" data-v-621375d3${_scopeId}><h3 class="mb-2" data-v-621375d3${_scopeId}>${ssrInterpolate(billboard.title)}</h3> <p class="mb-0" data-v-621375d3${_scopeId}>${ssrInterpolate(billboard.text)}</p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
              ...
              if (__props.billboard_list && __props.billboard_list.length > 1) {
                _push2(`<button class="carousel-control-prev" type="button" data-bs-target="#billboardCarousel" data-bs-slide="prev" data-v-621375d3${_scopeId}><span class="carousel-control-prev-icon" aria-hidden="true" data-v-621375d3${_scopeId}></span> <span class="visually-hidden" data-v-621375d3${_scopeId}>Previous</span></button>`);
              } else {
                _push2(`<!---->`);
              }
              if (__props.billboard_list && __props.billboard_list.length > 1) {
                _push2(`<button class="carousel-control-next" type="button" data-bs-target="#billboardCarousel" data-bs-slide="next" data-v-621375d3${_scopeId}><span class="carousel-control-next-icon" aria-hidden="true" data-v-621375d3${_scopeId}></span> <span class="visually-hidden" data-v-621375d3${_scopeId}>Next</span></button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            }
            _push2(`</div></div><div class="card shadow-sm flex-grow-1 rounded-3 border-0" data-v-621375d3${_scopeId}><div class="card-header d-flex justify-content-between align-items-center py-2 bg-white border-0 border-bottom rounded-top" data-v-621375d3${_scopeId}><h5 class="mb-0 fs-6 fw-medium text-secondary" data-v-621375d3${_scopeId}><i class="bi bi-paperclip me-2" data-v-621375d3${_scopeId}></i> Attachments </h5>`);
            if (unref(auth_user).roles_id === 1) {
              _push2(`<button class="btn btn-outline-success btn-sm rounded-circle p-0 lh-1" style="${ssrRenderStyle({ "width": "28px", "height": "28px" })}" title="Tambah Attachment" data-v-621375d3${_scopeId}><i class="bi bi-plus-lg" data-v-621375d3${_scopeId}></i></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="card-body pt-2" data-v-621375d3${_scopeId}><div class="row g-3" data-v-621375d3${_scopeId}><div class="col-md-6" data-v-621375d3${_scopeId}><h6 class="text-muted small mb-2" data-v-621375d3${_scopeId}><i class="bi bi-file-earmark-text me-1" data-v-621375d3${_scopeId}></i> Documents</h6><div class="attachment-list list-group list-group-flush small scroll-container-sm" data-v-621375d3${_scopeId}>`);
            if (document_list.value.length === 0) {
              _push2(`<div class="list-group-item text-muted text-center py-3 border-0 fst-italic" data-v-621375d3${_scopeId}><small data-v-621375d3${_scopeId}>No documents.</small></div>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(document_list.value, (document2) => {
                _push2(`<div class="list-group-item d-flex justify-content-between align-items-center px-0 py-1 border-bottom" data-v-621375d3${_scopeId}><a${ssrRenderAttr("href", `/storage/document/attachment/${document2.document}`)} class="text-decoration-none text-dark text-truncate me-2" download${ssrRenderAttr("title", document2.title)} data-v-621375d3${_scopeId}>${ssrInterpolate(document2.title)}</a>`);
                if (unref(auth_user).roles_id === 1) {
                  _push2(`<button class="btn btn-outline-danger border-0 btn-sm py-0 px-1" data-v-621375d3${_scopeId}><i class="bi bi-trash3" data-v-621375d3${_scopeId}></i></button>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
            ...
            _push2(`</div></div><div class="col-md-6" data-v-621375d3${_scopeId}><h6 class="text-muted small mb-2" data-v-621375d3${_scopeId}><i class="bi bi-link-45deg me-1" data-v-621375d3${_scopeId}></i> Links</h6><div class="attachment-list list-group list-group-flush small scroll-container-sm" data-v-621375d3${_scopeId}>`);
            if (link_list.value.length === 0) {
              _push2(`<div class="list-group-item text-muted text-center py-3 border-0 fst-italic" data-v-621375d3${_scopeId}><small data-v-621375d3${_scopeId}>No links.</small></div>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(link_list.value, (link) => {
                _push2(`<div class="list-group-item d-flex justify-content-between align-items-center px-0 py-1 border-bottom" data-v-621375d3${_scopeId}><a${ssrRenderAttr("href", link.link)} target="_blank" rel="noopener noreferrer" class="text-decoration-none text-primary text-truncate me-2"${ssrRenderAttr("title", link.title)} data-v-621375d3${_scopeId}>${ssrInterpolate(link.title)}</a>`);
                if (unref(auth_user).roles_id === 1) {
                  _push2(`<button class="btn btn-outline-danger border-0 btn-sm py-0 px-1" data-v-621375d3${_scopeId}><i class="bi bi-trash3" data-v-621375d3${_scopeId}></i></button>`);
                } else {
                  _push2(`<!---->`);
            ...
            _push2(`</div></div></div></div></div></div><div class="col-12 col-lg-3 d-flex" data-v-621375d3${_scopeId}><div class="card shadow-sm h-100 w-100 d-flex flex-column" data-v-621375d3${_scopeId}><div class="card-header d-flex justify-content-between align-items-center py-2 bg-primary text-white" data-v-621375d3${_scopeId}><h4 class="mb-0 fs-6 fw-medium" data-v-621375d3${_scopeId}><i class="bi bi-send me-2" data-v-621375d3${_scopeId}></i> SEEO POST </h4><button class="btn btn-light btn-sm rounded-circle p-0 lh-1" style="${ssrRenderStyle({ "width": "28px", "height": "28px" })}" title="Buat Postingan" data-v-621375d3${_scopeId}><i class="bi bi-plus-lg text-primary" data-v-621375d3${_scopeId}></i></button></div><div class="card-body d-flex flex-column overflow-hidden p-2" style="${ssrRenderStyle({ "max-height": "calc(100vh - 180px)" })}" data-v-621375d3${_scopeId}>`);
            if (!__props.post_list || __props.post_list.length === 0) {
              _push2(`<div class="flex-grow-1 d-flex flex-column align-items-center justify-content-center text-center text-muted p-4" data-v-621375d3${_scopeId}><i class="bi bi-chat-square-dots display-5 mb-3 opacity-50" data-v-621375d3${_scopeId}></i><h6 class="mb-1 text-secondary" data-v-621375d3${_scopeId}>Belum Ada Postingan</h6><p class="small mb-0 text-secondary" data-v-621375d3${_scopeId}>Jadilah yang pertama berbagi!</p></div>`);
            } else {
              _push2(`<div class="posts-list flex-grow-1 overflow-auto pe-1" data-v-621375d3${_scopeId}><!--[-->`);
              ssrRenderList(__props.post_list, (post) => {
                var _a2, _b2;
                _push2(`<div class="post-card bg-light border rounded p-2 mb-2" data-v-621375d3${_scopeId}><div class="d-flex justify-content-between align-items-start mb-1" data-v-621375d3${_scopeId}><div class="d-flex align-items-center text-truncate me-2" data-v-621375d3${_scopeId}><img${ssrRenderAttr("src", setPostImage(post.anonymus, (_a2 = post.user) == null ? void 0 : _a2.profile_image))} alt="Avatar" class="rounded-circle me-2" style="${ssrRenderStyle({ "width": "24px", "height": "24px", "object-fit": "cover" })}" data-v-621375d3${_scopeId}><div class="lh-sm" data-v-621375d3${_scopeId}><h6 class="mb-0 small fw-bold text-truncate" style="${ssrRenderStyle({ "max-width": "150px" })}" data-v-621375d3${_scopeId}>${ssrInterpolate(post.anonymus ? "Anonymous" : (_b2 = post.user) == null ? void 0 : _b2.name)}</h6><small class="text-muted" style="${ssrRenderStyle({ "font-size": "0.7rem" })}" data-v-621375d3${_scopeId}>${ssrInterpolate(new Date(post.created_at).toLocaleString("id-ID", { dateStyle: "short", timeStyle: "short" }))}</small></div></div>`);
                if (unref(auth_user).roles_id === 1 || !post.anonymus && unref(auth_user).id == post.user_id) {
                  _push2(`<button class="btn btn-outline-danger border-0 btn-sm py-0 px-1 flex-shrink-0" data-v-621375d3${_scopeId}><i class="bi bi-trash3 small" data-v-621375d3${_scopeId}></i></button>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><p class="mb-0 small post-text" style="${ssrRenderStyle({ "max-height": "110px", "overflow": "hidden" })}" data-v-621375d3${_scopeId}>${ssrInterpolate(post.text)}</p></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div></div></div></div></main><button class="btn btn-primary rounded-circle shadow fab d-lg-none" title="Buat Postingan" style="${ssrRenderStyle({ "width": "56px", "height": "56px" })}" data-v-621375d3${_scopeId}><i class="bi bi-send-plus fs-4" data-v-621375d3${_scopeId}></i></button></div></div></div><div class="modal fade" id="setBillboardModal" tabindex="-1" aria-labelledby="setBillboardModalLabel" aria-hidden="true" data-v-621375d3${_scopeId}><div class="modal-dialog modal-lg modal-dialog-centered" data-v-621375d3${_scopeId}><div class="modal-content" data-v-621375d3${_scopeId}><form data-v-621375d3${_scopeId}><div class="modal-header" data-v-621375d3${_scopeId}><h1 class="modal-title fs-5" id="setBillboardModalLabel" data-v-621375d3${_scopeId}>Tambah Billboard Baru</h1> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-v-621375d3${_scopeId}></button></div><div class="modal-body" data-v-621375d3${_scopeId}><div class="mb-3" data-v-621375d3${_scopeId}><label for="billboard_title_modal" class="form-label" data-v-621375d3${_scopeId}>Judul <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <input type="text" class="form-control" id="billboard_title_modal"${ssrRenderAttr("value", unref(form_billboard).billboard_title)} required data-v-621375d3${_scopeId}> `);
            _push2(ssrRenderComponent(_sfc_main$2, {
              message: __props.errors.billboard_title || unref(form_billboard).errors.billboard_title,
              class: "mt-1"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="mb-3" data-v-621375d3${_scopeId}><label class="form-label" data-v-621375d3${_scopeId}>Tipe <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <div class="d-flex gap-3" data-v-621375d3${_scopeId}><div class="form-check" data-v-621375d3${_scopeId}><input class="form-check-input" type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form_billboard).billboard_typeText) ? ssrLooseContain(unref(form_billboard).billboard_typeText, null) : unref(form_billboard).billboard_typeText) ? " checked" : ""} id="billboard_typeText_modal" data-v-621375d3${_scopeId}> <label class="form-check-label" for="billboard_typeText_modal" data-v-621375d3${_scopeId}> Teks </label></div> <div class="form-check" data-v-621375d3${_scopeId}><input class="form-check-input" type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form_billboard).billboard_typeImage) ? ssrLooseContain(unref(form_billboard).billboard_typeImage, null) : unref(form_billboard).billboard_typeImage) ? " checked" : ""} id="billboard_typeImage_modal" data-v-621375d3${_scopeId}> <label class="form-check-label" for="billboard_typeImage_modal" data-v-621375d3${_scopeId}> Gambar </label></div></div></div>`);
            if (unref(form_billboard).billboard_typeText) {
              _push2(`<div class="mb-3" data-v-621375d3${_scopeId}><label for="billboard_text_modal" class="form-label" data-v-621375d3${_scopeId}>Teks <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <textarea class="form-control" id="billboard_text_modal" rows="3"${ssrIncludeBooleanAttr(unref(form_billboard).billboard_typeText) ? " required" : ""} data-v-621375d3${_scopeId}>${ssrInterpolate(unref(form_billboard).billboard_text)}</textarea> `);
              _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            if (unref(form_billboard).billboard_typeImage) {
              _push2(`<div class="mb-3" data-v-621375d3${_scopeId}><label for="billboard_image_modal" class="form-label" data-v-621375d3${_scopeId}>Gambar <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <input class="form-control" type="file" id="billboard_image_modal" accept="image/jpeg,image/png,image/heic"${ssrIncludeBooleanAttr(unref(form_billboard).billboard_typeImage) ? " required" : ""} data-v-621375d3${_scopeId}> <div class="form-text" data-v-621375d3${_scopeId}>JPG, PNG, HEIC. Maks: 5MB.</div> `);
              _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            _push2(`</div><div class="modal-footer" data-v-621375d3${_scopeId}><button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-v-621375d3${_scopeId}>Batal</button> <button type="submit" class="btn btn-primary"${ssrIncludeBooleanAttr(unref(form_billboard).processing) ? " disabled" : ""} data-v-621375d3${_scopeId}>`);
            if (unref(form_billboard).processing) {
              _push2(`<span class="spinner-border spinner-border-sm me-1" aria-hidden="true" data-v-621375d3${_scopeId}></span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` Simpan </button></div></form></div></div></div><div class="modal fade" id="addAttachmentModal" tabindex="-1" aria-labelledby="addAttachmentModalLabel" aria-hidden="true" data-v-621375d3${_scopeId}><div class="modal-dialog modal-dialog-centered" data-v-621375d3${_scopeId}><div class="modal-content" data-v-621375d3${_scopeId}><form data-v-621375d3${_scopeId}><div class="modal-header" data-v-621375d3${_scopeId}><h1 class="modal-title fs-5" id="addAttachmentModalLabel" data-v-621375d3${_scopeId}>Tambah Attachment</h1> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-v-621375d3${_scopeId}></button></div><div class="modal-body" data-v-621375d3${_scopeId}><div class="mb-3" data-v-621375d3${_scopeId}><label for="attachment_title_modal" class="form-label" data-v-621375d3${_scopeId}>Judul <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <input type="text" class="form-control" id="attachment_title_modal"${ssrRenderAttr("value", unref(form_attachment).attachment_title)} required data-v-621375d3${_scopeId}> `);
            _push2(ssrRenderComponent(_sfc_main$2, {
              message: __props.errors.attachment_title || unref(form_attachment).errors.attachment_title,
              class: "mt-1"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="mb-3" data-v-621375d3${_scopeId}><label for="attachment_type_modal" class="form-label" data-v-621375d3${_scopeId}>Tipe <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <select class="form-select" id="attachment_type_modal" required data-v-621375d3${_scopeId}><option value="document" data-v-621375d3${ssrIncludeBooleanAttr(Array.isArray(unref(form_attachment).attachment_type) ? ssrLooseContain(unref(form_attachment).attachment_type, "document") : ssrLooseEqual(unref(form_attachment).attachment_type, "document")) ? " selected" : ""}${_scopeId}>Dokumen (File)</option> <option value="link" data-v-621375d3${ssrIncludeBooleanAttr(Array.isArray(unref(form_attachment).attachment_type) ? ssrLooseContain(unref(form_attachment).attachment_type, "link") : ssrLooseEqual(unref(form_attachment).attachment_type, "link")) ? " selected" : ""}${_scopeId}>Link Eksternal</option></select> `);
            _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            if (unref(form_attachment).attachment_type === "document") {
              _push2(`<div class="mb-3" data-v-621375d3${_scopeId}><label for="attachment_document_modal" class="form-label" data-v-621375d3${_scopeId}>Dokumen <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <input class="form-control" type="file" id="attachment_document_modal" accept=".pdf,.doc,.docx,.png,.jpeg,.jpg,.heic"${ssrIncludeBooleanAttr(unref(form_attachment).attachment_type === "document") ? " required" : ""} data-v-621375d3${_scopeId}> <div class="form-text" data-v-621375d3${_scopeId}>PDF, DOCX, PNG, JPG, HEIC. Maks: 5MB.</div> `);
              _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            if (unref(form_attachment).attachment_type === "link") {
              _push2(`<div class="mb-3" data-v-621375d3${_scopeId}><label for="attachment_link_modal" class="form-label" data-v-621375d3${_scopeId}>URL Link <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <input type="url" class="form-control" id="attachment_link_modal"${ssrRenderAttr("value", unref(form_attachment).attachment_link)} placeholder="https://contoh.com"${ssrIncludeBooleanAttr(unref(form_attachment).attachment_type === "link") ? " required" : ""} data-v-621375d3${_scopeId}> `);
              _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            _push2(`</div><div class="modal-footer" data-v-621375d3${_scopeId}><button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-v-621375d3${_scopeId}>Batal</button> <button type="submit" class="btn btn-primary"${ssrIncludeBooleanAttr(unref(form_attachment).processing) ? " disabled" : ""} data-v-621375d3${_scopeId}>`);
            if (unref(form_attachment).processing) {
              _push2(`<span class="spinner-border spinner-border-sm me-1" aria-hidden="true" data-v-621375d3${_scopeId}></span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` Simpan </button></div></form></div></div></div><div class="modal fade" id="addPostModal" tabindex="-1" aria-labelledby="addPostModalLabel" aria-hidden="true" data-v-621375d3${_scopeId}><div class="modal-dialog modal-dialog-centered" data-v-621375d3${_scopeId}><div class="modal-content" data-v-621375d3${_scopeId}><form data-v-621375d3${_scopeId}><div class="modal-header" data-v-621375d3${_scopeId}><h1 class="modal-title fs-5" id="addPostModalLabel" data-v-621375d3${_scopeId}>Buat Postingan Baru</h1> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-v-621375d3${_scopeId}></button></div><div class="modal-body" data-v-621375d3${_scopeId}><div class="mb-3" data-v-621375d3${_scopeId}><label for="post_text_modal" class="form-label" data-v-621375d3${_scopeId}>Isi Postingan <span class="text-danger" data-v-621375d3${_scopeId}>*</span></label> <textarea class="form-control" id="post_text_modal" rows="4" required maxlength="255" data-v-621375d3${_scopeId}>${ssrInterpolate(unref(form_post).post_text)}</textarea> <div class="form-text text-end small" data-v-621375d3${_scopeId}>${ssrInterpolate(((_a = unref(form_post).post_text) == null ? void 0 : _a.length) || 0)}/255 karakter</div> `);
            _push2(ssrRenderComponent(_sfc_main$2, {
              message: __props.errors.post_text || unref(form_post).errors.post_text,
              class: "mt-1"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="form-check" data-v-621375d3${_scopeId}><input class="form-check-input" type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form_post).post_username) ? ssrLooseContain(unref(form_post).post_username, null) : unref(form_post).post_username) ? " checked" : ""} id="post_username_modal" data-v-621375d3${_scopeId}> <label class="form-check-label" for="post_username_modal" data-v-621375d3${_scopeId}> Posting sebagai Anonymous </label></div></div><div class="modal-footer" data-v-621375d3${_scopeId}><button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-v-621375d3${_scopeId}>Batal</button> <button type="submit" class="btn btn-primary"${ssrIncludeBooleanAttr(unref(form_post).processing) ? " disabled" : ""} data-v-621375d3${_scopeId}>`);
                                  ...
                                  (openBlock(true), createBlock(Fragment, null, renderList(__props.billboard_list, (billboard, index) => {
                                    return openBlock(), createBlock("div", {
                                      ...
                                      createVNode("div", { class: "billboard-wrapper position-relative" }, [
                                        ...
                                        billboard.image && setBillboardImage(billboard.image) ? (openBlock(), createBlock("img", {
                                          key: 1,
                                          src: setBillboardImage(billboard.image),
                                          alt: "Billboard",
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-621375d3"]]);
export {
