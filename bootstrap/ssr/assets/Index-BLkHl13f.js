import { ref, computed, watch, withCtx, unref, createVNode, openBlock, createBlock, toDisplayString, withModifiers, withDirectives, vModelText, createCommentVNode, Fragment, renderList, vModelSelect, createTextVNode, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(StaffLayout, _attrs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="container-fluid internship-index-container" data-v-3c26ba07${_scopeId}><div class="main-card shadow-sm mt-4" data-v-3c26ba07${_scopeId}><div class="card-header-internship" data-v-3c26ba07${_scopeId}><div class="header-left" data-v-3c26ba07${_scopeId}><div class="header-info" data-v-3c26ba07${_scopeId}><h5 class="header-title" data-v-3c26ba07${_scopeId}>Internship SEEO 2025</h5><small class="header-subtitle" data-v-3c26ba07${_scopeId}>Sistem Manajemen Data Pendaftar</small></div></div><div class="header-actions" data-v-3c26ba07${_scopeId}><div class="export-group" data-v-3c26ba07${_scopeId}><div class="btn-group shadow-sm" role="group" data-v-3c26ba07${_scopeId}><div class="btn-group" role="group" data-v-3c26ba07${_scopeId}><button type="button" class="export-btn export-btn-pdf" data-bs-toggle="dropdown" aria-expanded="false"${ssrIncludeBooleanAttr(__props.applications.length === 0 || isExporting.value) ? " disabled" : ""} data-v-3c26ba07${_scopeId}>`);
            if (isExporting.value === "pdf") {
              _push2(`<span class="btn-spinner" role="status" data-v-3c26ba07${_scopeId}></span>`);
            } else {
              _push2(`<i class="bi bi-file-earmark-pdf" data-v-3c26ba07${_scopeId}></i>`);
            }
            _push2(`<span class="btn-text" data-v-3c26ba07${_scopeId}>${ssrInterpolate(isExporting.value === "pdf" ? "Generating..." : "Export PDF")}</span><i class="bi bi-chevron-down" data-v-3c26ba07${_scopeId}></i></button><ul class="dropdown-menu dropdown-menu-internship" data-v-3c26ba07${_scopeId}><li data-v-3c26ba07${_scopeId}><a class="dropdown-item-internship" href="#" data-v-3c26ba07${_scopeId}><i class="bi bi-table dropdown-icon text-primary" data-v-3c26ba07${_scopeId}></i><div class="dropdown-content" data-v-3c26ba07${_scopeId}><div class="dropdown-title" data-v-3c26ba07${_scopeId}>PDF Ringkas</div><small class="dropdown-subtitle" data-v-3c26ba07${_scopeId}>Tanpa alasan divisi</small></div></a></li><li data-v-3c26ba07${_scopeId}><hr class="dropdown-divider" data-v-3c26ba07${_scopeId}></li><li data-v-3c26ba07${_scopeId}><a class="dropdown-item-internship" href="#" data-v-3c26ba07${_scopeId}><i class="bi bi-file-text dropdown-icon text-success" data-v-3c26ba07${_scopeId}></i><div class="dropdown-content" data-v-3c26ba07${_scopeId}><div class="dropdown-title" data-v-3c26ba07${_scopeId}>PDF Lengkap</div><small class="dropdown-subtitle" data-v-3c26ba07${_scopeId}>Dengan alasan divisi</small></div></a></li></ul></div><button type="button" class="export-btn export-btn-excel"${ssrIncludeBooleanAttr(__props.applications.length === 0 || isExporting.value) ? " disabled" : ""} data-v-3c26ba07${_scopeId}>`);
            if (isExporting.value === "excel") {
              _push2(`<span class="btn-spinner" role="status" data-v-3c26ba07${_scopeId}></span>`);
            } else {
              _push2(`<i class="bi bi-file-earmark-excel" data-v-3c26ba07${_scopeId}></i>`);
            }
            _push2(`<span class="btn-text" data-v-3c26ba07${_scopeId}>${ssrInterpolate(isExporting.value === "excel" ? "Generating..." : "Export Excel")}</span></button></div></div><div class="data-counter" data-v-3c26ba07${_scopeId}><i class="bi bi-people" data-v-3c26ba07${_scopeId}></i><span data-v-3c26ba07${_scopeId}>${ssrInterpolate(filteredApplications.value.length)} / ${ssrInterpolate(__props.applications.length)}</span></div></div></div><div class="card-body-internship" data-v-3c26ba07${_scopeId}><div class="filter-section" data-v-3c26ba07${_scopeId}><div class="search-box" data-v-3c26ba07${_scopeId}><div class="search-input-group" data-v-3c26ba07${_scopeId}><span class="search-icon" data-v-3c26ba07${_scopeId}><i class="bi bi-search" data-v-3c26ba07${_scopeId}></i></span><input${ssrRenderAttr("value", searchQuery.value)} type="text" class="search-input" placeholder="Cari berdasarkan nama pendaftar..." data-v-3c26ba07${_scopeId}>`);
            if (searchQuery.value) {
              _push2(`<button class="search-clear" type="button" data-v-3c26ba07${_scopeId}><i class="bi bi-x" data-v-3c26ba07${_scopeId}></i></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="filter-box" data-v-3c26ba07${_scopeId}><select class="filter-select" data-v-3c26ba07${_scopeId}><option value="" data-v-3c26ba07${ssrIncludeBooleanAttr(Array.isArray(filterStudyProgram.value) ? ssrLooseContain(filterStudyProgram.value, "") : ssrLooseEqual(filterStudyProgram.value, "")) ? " selected" : ""}${_scopeId}>Semua Program Studi</option><!--[-->`);
            ssrRenderList(uniqueStudyPrograms.value, (program) => {
              _push2(`<option${ssrRenderAttr("value", program)} data-v-3c26ba07${ssrIncludeBooleanAttr(Array.isArray(filterStudyProgram.value) ? ssrLooseContain(filterStudyProgram.value, program) : ssrLooseEqual(filterStudyProgram.value, program)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(program)}</option>`);
            });
            _push2(`<!--]--></select></div><div class="filter-box" data-v-3c26ba07${_scopeId}><select class="filter-select" data-v-3c26ba07${_scopeId}><option value="" data-v-3c26ba07${ssrIncludeBooleanAttr(Array.isArray(filterYear.value) ? ssrLooseContain(filterYear.value, "") : ssrLooseEqual(filterYear.value, "")) ? " selected" : ""}${_scopeId}>Semua Tahun</option><!--[-->`);
            ssrRenderList(__props.availableYears, (year) => {
              _push2(`<option${ssrRenderAttr("value", year)} data-v-3c26ba07${ssrIncludeBooleanAttr(Array.isArray(filterYear.value) ? ssrLooseContain(filterYear.value, year) : ssrLooseEqual(filterYear.value, year)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(year)}</option>`);
            });
            _push2(`<!--]--></select></div></div><div class="stats-grid" data-v-3c26ba07${_scopeId}><div class="stat-card stat-primary" data-v-3c26ba07${_scopeId}><div class="stat-content" data-v-3c26ba07${_scopeId}><i class="bi bi-people stat-icon" data-v-3c26ba07${_scopeId}></i><div class="stat-details" data-v-3c26ba07${_scopeId}><h4 class="stat-number" data-v-3c26ba07${_scopeId}>${ssrInterpolate(filteredApplications.value.length)}</h4><small class="stat-label" data-v-3c26ba07${_scopeId}>Total Pendaftar</small></div></div></div><div class="stat-card stat-success" data-v-3c26ba07${_scopeId}><div class="stat-content" data-v-3c26ba07${_scopeId}><i class="bi bi-check-circle stat-icon" data-v-3c26ba07${_scopeId}></i><div class="stat-details" data-v-3c26ba07${_scopeId}><h4 class="stat-number" data-v-3c26ba07${_scopeId}>${ssrInterpolate(willingCount.value)}</h4><small class="stat-label" data-v-3c26ba07${_scopeId}>Bersedia Ditempatkan</small></div></div></div><div class="stat-card stat-warning" data-v-3c26ba07${_scopeId}><div class="stat-content" data-v-3c26ba07${_scopeId}><i class="bi bi-x-circle stat-icon" data-v-3c26ba07${_scopeId}></i><div class="stat-details" data-v-3c26ba07${_scopeId}><h4 class="stat-number" data-v-3c26ba07${_scopeId}>${ssrInterpolate(notWillingCount.value)}</h4><small class="stat-label" data-v-3c26ba07${_scopeId}>Tidak Bersedia</small></div></div></div><div class="stat-card stat-info" data-v-3c26ba07${_scopeId}><div class="stat-content" data-v-3c26ba07${_scopeId}><i class="bi bi-mortarboard stat-icon" data-v-3c26ba07${_scopeId}></i><div class="stat-details" data-v-3c26ba07${_scopeId}><h4 class="stat-number" data-v-3c26ba07${_scopeId}>${ssrInterpolate(uniqueStudyPrograms.value.length)}</h4><small class="stat-label" data-v-3c26ba07${_scopeId}>Program Studi</small></div></div></div><div class="stat-card stat-gradient" data-v-3c26ba07${_scopeId}><div class="stat-content" data-v-3c26ba07${_scopeId}><i class="bi bi-diagram-3 stat-icon" data-v-3c26ba07${_scopeId}></i><div class="stat-details" data-v-3c26ba07${_scopeId}><h4 class="stat-number" data-v-3c26ba07${_scopeId}>${ssrInterpolate(allDivisionStats.value.length)}</h4><small class="stat-label" data-v-3c26ba07${_scopeId}>Divisi Tersedia</small></div></div><div class="stat-action" data-v-3c26ba07${_scopeId}><button class="stats-btn"${ssrIncludeBooleanAttr(allDivisionStats.value.length === 0) ? " disabled" : ""} data-v-3c26ba07${_scopeId}><i class="bi bi-bar-chart" data-v-3c26ba07${_scopeId}></i><span data-v-3c26ba07${_scopeId}>Lihat Statistik</span></button></div></div></div><div class="table-container" data-v-3c26ba07${_scopeId}><table class="data-table" data-v-3c26ba07${_scopeId}><thead class="table-header" data-v-3c26ba07${_scopeId}><tr data-v-3c26ba07${_scopeId}><th scope="col" class="th-center" data-v-3c26ba07${_scopeId}>#</th><th scope="col" data-v-3c26ba07${_scopeId}><div class="sortable-header-internship" data-v-3c26ba07${_scopeId}><span data-v-3c26ba07${_scopeId}>Nama</span><i class="${ssrRenderClass([{ "active": sortField.value === "name" }, "bi bi-arrow-down-up sort-icon-internship"])}" data-v-3c26ba07${_scopeId}></i></div></th><th scope="col" data-v-3c26ba07${_scopeId}>NIM</th><th scope="col" data-v-3c26ba07${_scopeId}>Email</th><th scope="col" data-v-3c26ba07${_scopeId}>No. HP</th><th scope="col" data-v-3c26ba07${_scopeId}><div class="sortable-header-internship" data-v-3c26ba07${_scopeId}><span data-v-3c26ba07${_scopeId}>Program Studi</span><i class="${ssrRenderClass([{ "active": sortField.value === "study_program" }, "bi bi-arrow-down-up sort-icon-internship"])}" data-v-3c26ba07${_scopeId}></i></div></th><th scope="col" data-v-3c26ba07${_scopeId}>Pilihan Divisi 1</th><th scope="col" class="hide-mobile" data-v-3c26ba07${_scopeId}>Alasan Divisi 1</th><th scope="col" data-v-3c26ba07${_scopeId}>Pilihan Divisi 2</th><th scope="col" class="hide-mobile" data-v-3c26ba07${_scopeId}>Alasan Divisi 2</th><th scope="col" data-v-3c26ba07${_scopeId}>Status</th><th scope="col" data-v-3c26ba07${_scopeId}><div class="sortable-header-internship" data-v-3c26ba07${_scopeId}><span data-v-3c26ba07${_scopeId}>Tanggal Daftar</span><i class="${ssrRenderClass([{ "active": sortField.value === "created_at" }, "bi bi-arrow-down-up sort-icon-internship"])}" data-v-3c26ba07${_scopeId}></i></div></th><th scope="col" class="th-center" data-v-3c26ba07${_scopeId}>Aksi</th></tr></thead><tbody class="table-body" data-v-3c26ba07${_scopeId}>`);
            if (filteredApplications.value.length === 0) {
              _push2(`<tr class="empty-row" data-v-3c26ba07${_scopeId}><td colspan="13" class="empty-cell" data-v-3c26ba07${_scopeId}><div class="empty-state-internship" data-v-3c26ba07${_scopeId}><i class="bi bi-inbox empty-icon" data-v-3c26ba07${_scopeId}></i><h5 class="empty-title" data-v-3c26ba07${_scopeId}>${ssrInterpolate(__props.applications.length === 0 ? "Belum Ada Data" : "Tidak Ada Hasil")}</h5><p class="empty-description" data-v-3c26ba07${_scopeId}>${ssrInterpolate(__props.applications.length === 0 ? "Belum ada pendaftar yang terdaftar." : "Tidak ada data yang sesuai dengan pencarian Anda.")}</p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(paginatedApplications.value, (app, index) => {
              _push2(`<tr class="table-row" data-v-3c26ba07${_scopeId}><td class="td-center" data-v-3c26ba07${_scopeId}><span class="row-number" data-v-3c26ba07${_scopeId}>${ssrInterpolate((currentPage.value - 1) * itemsPerPage.value + index + 1)}</span></td><td class="td-name" data-v-3c26ba07${_scopeId}><div class="name-cell" data-v-3c26ba07${_scopeId}><div class="name-primary" data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.name)}</div><small class="name-secondary" data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.nim)}</small></div></td><td class="td-nim" data-v-3c26ba07${_scopeId}><span data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.nim)}</span></td><td class="td-email" data-v-3c26ba07${_scopeId}><a${ssrRenderAttr("href", `mailto:${app.email}`)} class="email-link" data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.email)}</a></td><td class="td-phone" data-v-3c26ba07${_scopeId}><a${ssrRenderAttr("href", getWhatsAppLink(app.phone_number))} target="_blank" class="phone-link"${ssrRenderAttr("title", `Chat WhatsApp ${app.name}`)} data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.phone_number)}</a></td><td class="td-program" data-v-3c26ba07${_scopeId}><span data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.study_program)}</span></td><td class="td-division" data-v-3c26ba07${_scopeId}><span class="division-text" data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.division_choice_1)}</span></td><td class="td-reason hide-mobile" data-v-3c26ba07${_scopeId}><span${ssrRenderAttr("title", app.reason_choice_1)} class="reason-text" data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.reason_choice_1)}</span></td><td class="td-division" data-v-3c26ba07${_scopeId}><span class="division-text" data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.division_choice_2)}</span></td><td class="td-reason hide-mobile" data-v-3c26ba07${_scopeId}><span${ssrRenderAttr("title", app.reason_choice_2)} class="reason-text" data-v-3c26ba07${_scopeId}>${ssrInterpolate(app.reason_choice_2)}</span></td><td class="td-center" data-v-3c26ba07${_scopeId}>`);
              if (app.willing_to_be_placed_elsewhere) {
                _push2(`<span class="status-badge status-success" data-v-3c26ba07${_scopeId}><i class="bi bi-check-circle" data-v-3c26ba07${_scopeId}></i>Bersedia </span>`);
              } else {
                _push2(`<span class="status-badge status-danger" data-v-3c26ba07${_scopeId}><i class="bi bi-x-circle" data-v-3c26ba07${_scopeId}></i>Tidak Bersedia </span>`);
              }
              _push2(`</td><td class="td-date" data-v-3c26ba07${_scopeId}><small data-v-3c26ba07${_scopeId}>${ssrInterpolate(formatDate(app.created_at))}</small></td><td class="td-action" data-v-3c26ba07${_scopeId}><div class="action-group" data-v-3c26ba07${_scopeId}><button class="action-btn action-btn-info"${ssrRenderAttr("title", `Detail ${app.name}`)} data-v-3c26ba07${_scopeId}><i class="bi bi-eye" data-v-3c26ba07${_scopeId}></i><span data-v-3c26ba07${_scopeId}>Detail</span></button><button class="action-btn action-btn-primary"${ssrRenderAttr("title", `Lihat KRS ${app.name}`)} data-v-3c26ba07${_scopeId}><i class="bi bi-file-earmark-image" data-v-3c26ba07${_scopeId}></i><span data-v-3c26ba07${_scopeId}>KRS</span></button></div></td></tr>`);
            });
            _push2(`<!--]--></tbody></table></div>`);
            if (totalPages.value > 1) {
              _push2(`<div class="pagination-section" data-v-3c26ba07${_scopeId}><div class="pagination-info" data-v-3c26ba07${_scopeId}> Menampilkan <strong data-v-3c26ba07${_scopeId}>${ssrInterpolate((currentPage.value - 1) * itemsPerPage.value + 1)}</strong> - <strong data-v-3c26ba07${_scopeId}>${ssrInterpolate(Math.min(currentPage.value * itemsPerPage.value, filteredApplications.value.length))}</strong> dari <strong data-v-3c26ba07${_scopeId}>${ssrInterpolate(filteredApplications.value.length)}</strong> data </div><nav class="pagination-nav" data-v-3c26ba07${_scopeId}><ul class="pagination-list" data-v-3c26ba07${_scopeId}><li class="${ssrRenderClass([{ disabled: currentPage.value === 1 }, "page-item-internship"])}" data-v-3c26ba07${_scopeId}><button class="page-link-internship"${ssrIncludeBooleanAttr(currentPage.value === 1) ? " disabled" : ""} data-v-3c26ba07${_scopeId}><i class="bi bi-chevron-double-left" data-v-3c26ba07${_scopeId}></i></button></li><li class="${ssrRenderClass([{ disabled: currentPage.value === 1 }, "page-item-internship"])}" data-v-3c26ba07${_scopeId}><button class="page-link-internship"${ssrIncludeBooleanAttr(currentPage.value === 1) ? " disabled" : ""} data-v-3c26ba07${_scopeId}><i class="bi bi-chevron-left" data-v-3c26ba07${_scopeId}></i></button></li><!--[-->`);
              ssrRenderList(visiblePages.value, (page) => {
                _push2(`<li class="${ssrRenderClass([{ active: page === currentPage.value }, "page-item-internship"])}" data-v-3c26ba07${_scopeId}><button class="page-link-internship" data-v-3c26ba07${_scopeId}>${ssrInterpolate(page)}</button></li>`);
              });
              _push2(`<!--]--><li class="${ssrRenderClass([{ disabled: currentPage.value === totalPages.value }, "page-item-internship"])}" data-v-3c26ba07${_scopeId}><button class="page-link-internship"${ssrIncludeBooleanAttr(currentPage.value === totalPages.value) ? " disabled" : ""} data-v-3c26ba07${_scopeId}><i class="bi bi-chevron-right" data-v-3c26ba07${_scopeId}></i></button></li><li class="${ssrRenderClass([{ disabled: currentPage.value === totalPages.value }, "page-item-internship"])}" data-v-3c26ba07${_scopeId}><button class="page-link-internship"${ssrIncludeBooleanAttr(currentPage.value === totalPages.value) ? " disabled" : ""} data-v-3c26ba07${_scopeId}><i class="bi bi-chevron-double-right" data-v-3c26ba07${_scopeId}></i></button></li></ul></nav></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="modal fade" id="divisionStatsModal" tabindex="-1" aria-labelledby="divisionStatsModalLabel" aria-hidden="true" data-v-3c26ba07${_scopeId}><div class="modal-dialog modal-xl" data-v-3c26ba07${_scopeId}><div class="modal-content modal-content-stats" data-v-3c26ba07${_scopeId}><div class="modal-header-stats" data-v-3c26ba07${_scopeId}><div class="modal-header-content" data-v-3c26ba07${_scopeId}><i class="bi bi-diagram-3 modal-icon-stats" data-v-3c26ba07${_scopeId}></i><div class="modal-title-section" data-v-3c26ba07${_scopeId}><h5 class="modal-title-stats" data-v-3c26ba07${_scopeId}>Statistik Per Divisi</h5><small class="modal-subtitle-stats" data-v-3c26ba07${_scopeId}>Data berdasarkan pilihan pendaftar</small></div></div><button type="button" class="modal-close-stats" data-bs-dismiss="modal" data-v-3c26ba07${_scopeId}><i class="bi bi-x" data-v-3c26ba07${_scopeId}></i></button></div><div class="modal-body-stats" data-v-3c26ba07${_scopeId}><div class="stats-summary" data-v-3c26ba07${_scopeId}><div class="summary-card summary-primary" data-v-3c26ba07${_scopeId}><div class="summary-content" data-v-3c26ba07${_scopeId}><i class="bi bi-building" data-v-3c26ba07${_scopeId}></i><div class="summary-details" data-v-3c26ba07${_scopeId}><h6 data-v-3c26ba07${_scopeId}>${ssrInterpolate(allDivisionStats.value.length)}</h6><small data-v-3c26ba07${_scopeId}>Total Divisi</small></div></div></div><div class="summary-card summary-success" data-v-3c26ba07${_scopeId}><div class="summary-content" data-v-3c26ba07${_scopeId}><i class="bi bi-person-check" data-v-3c26ba07${_scopeId}></i><div class="summary-details" data-v-3c26ba07${_scopeId}><h6 data-v-3c26ba07${_scopeId}>${ssrInterpolate(totalDivisionChoices.value)}</h6><small data-v-3c26ba07${_scopeId}>Total Pilihan</small></div></div></div><div class="summary-card summary-info" data-v-3c26ba07${_scopeId}><div class="summary-content" data-v-3c26ba07${_scopeId}><i class="bi bi-trophy" data-v-3c26ba07${_scopeId}></i><div class="summary-details" data-v-3c26ba07${_scopeId}><h6 data-v-3c26ba07${_scopeId}>${ssrInterpolate(((_a = topDivision.value) == null ? void 0 : _a.name) || "-")}</h6><small data-v-3c26ba07${_scopeId}>Paling Diminati</small></div></div></div></div><div class="division-stats-list" data-v-3c26ba07${_scopeId}><h6 class="list-title" data-v-3c26ba07${_scopeId}><i class="bi bi-list-ul" data-v-3c26ba07${_scopeId}></i> Daftar Divisi &amp; Jumlah Pendaftar </h6><div class="division-items" data-v-3c26ba07${_scopeId}><!--[-->`);
            ssrRenderList(allDivisionStats.value, (division, index) => {
              _push2(`<div class="${ssrRenderClass([{ "most-popular": index === 0 }, "division-item"])}" data-v-3c26ba07${_scopeId}><div class="division-info" data-v-3c26ba07${_scopeId}><div class="division-header-item" data-v-3c26ba07${_scopeId}><h6 class="division-name-item" data-v-3c26ba07${_scopeId}><i class="bi bi-building division-icon" data-v-3c26ba07${_scopeId}></i> ${ssrInterpolate(division.name)} `);
              if (index === 0) {
                _push2(`<span class="popular-badge" data-v-3c26ba07${_scopeId}><i class="bi bi-star-fill" data-v-3c26ba07${_scopeId}></i> Terpopuler </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</h6></div><div class="division-stats-row" data-v-3c26ba07${_scopeId}><div class="stat-item" data-v-3c26ba07${_scopeId}><span class="stat-icon" data-v-3c26ba07${_scopeId}><i class="bi bi-1-circle" data-v-3c26ba07${_scopeId}></i></span><div class="stat-content-item" data-v-3c26ba07${_scopeId}><span class="stat-value" data-v-3c26ba07${_scopeId}>${ssrInterpolate(division.choice1)}</span><span class="stat-text" data-v-3c26ba07${_scopeId}>Pilihan 1</span></div></div><div class="stat-item" data-v-3c26ba07${_scopeId}><span class="stat-icon" data-v-3c26ba07${_scopeId}><i class="bi bi-2-circle" data-v-3c26ba07${_scopeId}></i></span><div class="stat-content-item" data-v-3c26ba07${_scopeId}><span class="stat-value" data-v-3c26ba07${_scopeId}>${ssrInterpolate(division.choice2)}</span><span class="stat-text" data-v-3c26ba07${_scopeId}>Pilihan 2</span></div></div><div class="stat-item total-item" data-v-3c26ba07${_scopeId}><span class="stat-icon" data-v-3c26ba07${_scopeId}><i class="bi bi-plus-circle" data-v-3c26ba07${_scopeId}></i></span><div class="stat-content-item" data-v-3c26ba07${_scopeId}><span class="stat-value total-value" data-v-3c26ba07${_scopeId}>${ssrInterpolate(division.total)}</span><span class="stat-text" data-v-3c26ba07${_scopeId}>Total</span></div></div></div><div class="progress-container" data-v-3c26ba07${_scopeId}><div class="progress-bar-stats" data-v-3c26ba07${_scopeId}><div class="progress-fill-stats" style="${ssrRenderStyle({ width: `${division.total / maxDivisionTotal.value * 100}%` })}" data-v-3c26ba07${_scopeId}></div></div><span class="progress-percentage" data-v-3c26ba07${_scopeId}>${ssrInterpolate((division.total / totalDivisionChoices.value * 100).toFixed(1))}% </span></div></div></div>`);
            });
            _push2(`<!--]--></div></div></div><div class="modal-footer-stats" data-v-3c26ba07${_scopeId}><div class="footer-info" data-v-3c26ba07${_scopeId}><small class="text-muted" data-v-3c26ba07${_scopeId}><i class="bi bi-info-circle" data-v-3c26ba07${_scopeId}></i> Data diperbarui secara real-time berdasarkan filter yang aktif </small></div><div class="modal-actions-stats" data-v-3c26ba07${_scopeId}><button type="button" class="btn-close-stats" data-bs-dismiss="modal" data-v-3c26ba07${_scopeId}><i class="bi bi-x" data-v-3c26ba07${_scopeId}></i> Tutup </button></div></div></div></div></div><div class="modal fade" id="detailModal" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true" data-v-3c26ba07${_scopeId}><div class="modal-dialog modal-xl" data-v-3c26ba07${_scopeId}><div class="modal-content modal-content-internship" data-v-3c26ba07${_scopeId}><div class="modal-header-internship" data-v-3c26ba07${_scopeId}><div class="modal-header-content" data-v-3c26ba07${_scopeId}><i class="bi bi-person-circle modal-icon" data-v-3c26ba07${_scopeId}></i><div class="modal-title-section" data-v-3c26ba07${_scopeId}><h5 class="modal-title-internship" data-v-3c26ba07${_scopeId}>Detail Pendaftar Internship</h5>`);
            if (selectedApp.value) {
              _push2(`<small class="modal-subtitle" data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.name)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><button type="button" class="modal-close" data-bs-dismiss="modal" data-v-3c26ba07${_scopeId}><i class="bi bi-x" data-v-3c26ba07${_scopeId}></i></button></div>`);
            if (selectedApp.value) {
              _push2(`<div class="modal-body-internship" data-v-3c26ba07${_scopeId}><div class="modal-grid" data-v-3c26ba07${_scopeId}><div class="info-section" data-v-3c26ba07${_scopeId}><div class="info-card-internship" data-v-3c26ba07${_scopeId}><div class="info-header" data-v-3c26ba07${_scopeId}><h6 class="info-title" data-v-3c26ba07${_scopeId}><i class="bi bi-person-fill info-icon" data-v-3c26ba07${_scopeId}></i> Informasi Personal </h6></div><div class="info-body" data-v-3c26ba07${_scopeId}><div class="info-table" data-v-3c26ba07${_scopeId}><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>Nama Lengkap:</span><span class="info-value" data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.name)}</span></div><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>NIM:</span><span class="info-value" data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.nim)}</span></div><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>Email:</span><span class="info-value" data-v-3c26ba07${_scopeId}><a${ssrRenderAttr("href", `mailto:${selectedApp.value.email}`)} class="info-link" data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.email)}</a></span></div><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>No. HP:</span><span class="info-value" data-v-3c26ba07${_scopeId}><div class="phone-group" data-v-3c26ba07${_scopeId}><span data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.phone_number)}</span><a${ssrRenderAttr("href", getWhatsAppLink(selectedApp.value.phone_number))} target="_blank" class="whatsapp-btn" data-v-3c26ba07${_scopeId}><i class="bi bi-whatsapp" data-v-3c26ba07${_scopeId}></i>Chat </a></div></span></div><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>Program Studi:</span><span class="info-value" data-v-3c26ba07${_scopeId}><span class="program-badge" data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.study_program)}</span></span></div></div></div></div></div><div class="info-section" data-v-3c26ba07${_scopeId}><div class="info-card-internship" data-v-3c26ba07${_scopeId}><div class="info-header" data-v-3c26ba07${_scopeId}><h6 class="info-title" data-v-3c26ba07${_scopeId}><i class="bi bi-building info-icon" data-v-3c26ba07${_scopeId}></i> Informasi Pendaftaran </h6></div><div class="info-body" data-v-3c26ba07${_scopeId}><div class="info-table" data-v-3c26ba07${_scopeId}><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>Tanggal Daftar:</span><span class="info-value" data-v-3c26ba07${_scopeId}>${ssrInterpolate(formatDate(selectedApp.value.created_at))}</span></div><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>Bersedia Ditempatkan:</span><span class="info-value" data-v-3c26ba07${_scopeId}>`);
              if (selectedApp.value.willing_to_be_placed_elsewhere) {
                _push2(`<span class="status-badge status-success" data-v-3c26ba07${_scopeId}><i class="bi bi-check-circle" data-v-3c26ba07${_scopeId}></i>Ya, Bersedia </span>`);
              } else {
                _push2(`<span class="status-badge status-danger" data-v-3c26ba07${_scopeId}><i class="bi bi-x-circle" data-v-3c26ba07${_scopeId}></i>Tidak Bersedia </span>`);
              }
              _push2(`</span></div><div class="info-row" data-v-3c26ba07${_scopeId}><span class="info-label" data-v-3c26ba07${_scopeId}>Status Review:</span><span class="info-value" data-v-3c26ba07${_scopeId}><span class="${ssrRenderClass([selectedApp.value.status === "accepted" ? "status-success" : selectedApp.value.status === "rejected" ? "status-danger" : "status-warning", "status-badge"])}" data-v-3c26ba07${_scopeId}><i class="${ssrRenderClass(selectedApp.value.status === "accepted" ? "bi bi-check-circle" : selectedApp.value.status === "rejected" ? "bi bi-x-circle" : "bi bi-hourglass-split")}" data-v-3c26ba07${_scopeId}></i> ${ssrInterpolate(selectedApp.value.status || "pending")}</span></span></div></div></div></div></div></div><div class="modal-divider" data-v-3c26ba07${_scopeId}></div><div class="modal-grid" data-v-3c26ba07${_scopeId}><div class="division-section" data-v-3c26ba07${_scopeId}><div class="division-card division-primary" data-v-3c26ba07${_scopeId}><div class="division-header" data-v-3c26ba07${_scopeId}><h6 class="division-title" data-v-3c26ba07${_scopeId}><i class="bi bi-1-circle" data-v-3c26ba07${_scopeId}></i> Pilihan Divisi Pertama </h6></div><div class="division-body" data-v-3c26ba07${_scopeId}><h6 class="division-name" data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.division_choice_1)}</h6><div class="division-reason" data-v-3c26ba07${_scopeId}><p data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.reason_choice_1)}</p></div></div></div></div><div class="division-section" data-v-3c26ba07${_scopeId}><div class="division-card division-info" data-v-3c26ba07${_scopeId}><div class="division-header" data-v-3c26ba07${_scopeId}><h6 class="division-title" data-v-3c26ba07${_scopeId}><i class="bi bi-2-circle" data-v-3c26ba07${_scopeId}></i> Pilihan Divisi Kedua </h6></div><div class="division-body" data-v-3c26ba07${_scopeId}><h6 class="division-name" data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.division_choice_2)}</h6><div class="division-reason" data-v-3c26ba07${_scopeId}><p data-v-3c26ba07${_scopeId}>${ssrInterpolate(selectedApp.value.reason_choice_2)}</p></div></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="modal-footer-internship" data-v-3c26ba07${_scopeId}><div class="modal-actions" data-v-3c26ba07${_scopeId}>`);
            if (selectedApp.value) {
              _push2(`<a${ssrRenderAttr("href", getWhatsAppLink(selectedApp.value.phone_number))} target="_blank" class="modal-btn modal-btn-success" data-v-3c26ba07${_scopeId}><i class="bi bi-whatsapp" data-v-3c26ba07${_scopeId}></i>Chat WhatsApp </a>`);
            } else {
              _push2(`<!---->`);
            }
            if (selectedApp.value) {
              _push2(`<a${ssrRenderAttr("href", `mailto:${selectedApp.value.email}?subject=Internship SEEO 2025 - ${selectedApp.value.name}`)} class="modal-btn modal-btn-info" data-v-3c26ba07${_scopeId}><i class="bi bi-envelope" data-v-3c26ba07${_scopeId}></i>Kirim Email </a>`);
            } else {
              _push2(`<!---->`);
            }
            if (selectedApp.value && (__props.user.is_ceo || __props.user.is_hr_manager || __props.user.is_internship_pic || __props.user.role_id === 15)) {
              _push2(`<button type="button" class="modal-btn modal-btn-success" data-v-3c26ba07${_scopeId}><i class="bi bi-check-circle" data-v-3c26ba07${_scopeId}></i>Terima </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (selectedApp.value && (__props.user.is_ceo || __props.user.is_hr_manager || __props.user.is_internship_pic || __props.user.role_id === 15)) {
              _push2(`<button type="button" class="modal-btn modal-btn-danger" data-v-3c26ba07${_scopeId}><i class="bi bi-x-circle" data-v-3c26ba07${_scopeId}></i>Tolak </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button type="button" class="modal-btn modal-btn-secondary" data-bs-dismiss="modal" data-v-3c26ba07${_scopeId}><i class="bi bi-x" data-v-3c26ba07${_scopeId}></i>Tutup </button></div></div></div></div></div><div class="modal fade" id="krsModal" tabindex="-1" aria-labelledby="krsModalLabel" aria-hidden="true" data-v-3c26ba07${_scopeId}><div class="modal-dialog modal-xl modal-dialog-centered" data-v-3c26ba07${_scopeId}><div class="modal-content krs-modal-content" data-v-3c26ba07${_scopeId}><div class="modal-header krs-modal-header" data-v-3c26ba07${_scopeId}><h5 class="modal-title" id="krsModalLabel" data-v-3c26ba07${_scopeId}><i class="bi bi-file-earmark-image me-2" data-v-3c26ba07${_scopeId}></i> KRS - ${ssrInterpolate((_b = selectedKRSApp.value) == null ? void 0 : _b.name)}</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-v-3c26ba07${_scopeId}></button></div><div class="modal-body krs-modal-body" data-v-3c26ba07${_scopeId}>`);
            if (selectedKRSApp.value) {
              _push2(`<div class="krs-container" data-v-3c26ba07${_scopeId}><div class="krs-info" data-v-3c26ba07${_scopeId}><div class="info-item" data-v-3c26ba07${_scopeId}><strong data-v-3c26ba07${_scopeId}>Nama:</strong> ${ssrInterpolate(selectedKRSApp.value.name)}</div><div class="info-item" data-v-3c26ba07${_scopeId}><strong data-v-3c26ba07${_scopeId}>NIM:</strong> ${ssrInterpolate(selectedKRSApp.value.nim)}</div><div class="info-item" data-v-3c26ba07${_scopeId}><strong data-v-3c26ba07${_scopeId}>Program Studi:</strong> ${ssrInterpolate(selectedKRSApp.value.study_program)}</div></div><div class="krs-viewer" data-v-3c26ba07${_scopeId}>`);
              if (getFileType(selectedKRSApp.value.krs_path) === "pdf") {
                _push2(`<iframe${ssrRenderAttr("src", "/storage/" + selectedKRSApp.value.krs_path)} class="krs-pdf-viewer" frameborder="0" data-v-3c26ba07${_scopeId}></iframe>`);
              } else {
                _push2(`<img${ssrRenderAttr("src", "/storage/" + selectedKRSApp.value.krs_path)}${ssrRenderAttr("alt", "KRS " + selectedKRSApp.value.name)} class="krs-image-viewer" data-v-3c26ba07${_scopeId}>`);
              }
              _push2(`</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="modal-footer krs-modal-footer" data-v-3c26ba07${_scopeId}>`);
            if (selectedKRSApp.value) {
              _push2(`<a${ssrRenderAttr("href", "/storage/" + selectedKRSApp.value.krs_path)} target="_blank" class="btn-download-krs" data-v-3c26ba07${_scopeId}><i class="bi bi-download" data-v-3c26ba07${_scopeId}></i> Download KRS </a>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button type="button" class="btn-close-krs" data-bs-dismiss="modal" data-v-3c26ba07${_scopeId}><i class="bi bi-x-lg" data-v-3c26ba07${_scopeId}></i> Tutup </button></div></div></div></div>`);
          } else {
            return [
                ...
                createVNode("div", { class: "main-card shadow-sm mt-4" }, [
                  ...
                  createVNode("div", { class: "card-body-internship" }, [
                    createVNode("div", { class: "filter-section" }, [
                      ...
                      createVNode("div", { class: "filter-box" }, [
                        withDirectives(createVNode("select", {
                          "onUpdate:modelValue": ($event) => filterYear.value = $event,
                          class: "filter-select"
                        }, [
                          createVNode("option", { value: "" }, "Semua Tahun"),
                          (openBlock(true), createBlock(Fragment, null, renderList(__props.availableYears, (year) => {
                            return openBlock(), createBlock("option", {
                              key: year,
                              value: year
                  ...
                  createVNode("div", { class: "modal-content modal-content-internship" }, [
                          ...
                          createVNode("div", { class: "info-card-internship" }, [
                            ...
                            createVNode("div", { class: "info-body" }, [
                              createVNode("div", { class: "info-table" }, [
                                ...
                                createVNode("div", { class: "info-row" }, [
                                  createVNode("span", { class: "info-label" }, "Status Review:"),
                                  createVNode("span", { class: "info-value" }, [
                                    createVNode("span", {
                                      class: ["status-badge", selectedApp.value.status === "accepted" ? "status-success" : selectedApp.value.status === "rejected" ? "status-danger" : "status-warning"]
                                    }, [
                                      createVNode("i", {
                                        class: selectedApp.value.status === "accepted" ? "bi bi-check-circle" : selectedApp.value.status === "rejected" ? "bi bi-x-circle" : "bi bi-hourglass-split"
                                      }, null, 2),
                                      createTextVNode(" " + toDisplayString(selectedApp.value.status || "pending"), 1)
                                    ], 2)
                                  ])
                                ])
                              ])
                    ...
                    createVNode("div", { class: "modal-footer-internship" }, [
                      createVNode("div", { class: "modal-actions" }, [
                        ...
                        selectedApp.value && (__props.user.is_ceo || __props.user.is_hr_manager || __props.user.is_internship_pic || __props.user.role_id === 15) ? (openBlock(), createBlock("button", {
                          key: 2,
                          type: "button",
                          class: "modal-btn modal-btn-success",
                          onClick: ($event) => sendDecision("accepted")
                        }, [
                          createVNode("i", { class: "bi bi-check-circle" }),
                          createTextVNode("Terima ")
                        ], 8, ["onClick"])) : createCommentVNode("", true),
                        selectedApp.value && (__props.user.is_ceo || __props.user.is_hr_manager || __props.user.is_internship_pic || __props.user.role_id === 15) ? (openBlock(), createBlock("button", {
                          key: 3,
                          type: "button",
                          class: "modal-btn modal-btn-danger",
                          onClick: ($event) => sendDecision("rejected")
                        }, [
                          createVNode("i", { class: "bi bi-x-circle" }),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3c26ba07"]]);
export {
  Index as default
};
//# sourceMappingURL=Index-BLkHl13f.js.map
