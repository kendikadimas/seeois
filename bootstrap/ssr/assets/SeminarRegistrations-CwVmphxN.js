import { ref, unref, withCtx, createTextVNode, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, toDisplayString, withDirectives, vModelText, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(StaffLayout, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container-fluid py-4" data-v-90bc4bdd${_scopeId}>`);
            if (__props.notif) {
            ...
            _push2(`<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4" data-v-90bc4bdd${_scopeId}><div data-v-90bc4bdd${_scopeId}><h4 class="mb-1" data-v-90bc4bdd${_scopeId}>Daftar Event Seminar</h4><p class="text-muted small mb-0" data-v-90bc4bdd${_scopeId}>Kelola berbagai event seminar dan pantau pendaftar di setiap event.</p></div><div data-v-90bc4bdd${_scopeId}><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAddEvent" data-v-90bc4bdd${_scopeId}><i class="bi bi-plus-lg me-1" data-v-90bc4bdd${_scopeId}></i> Tambah Event Baru </button></div></div><div class="row g-4" data-v-90bc4bdd${_scopeId}><!--[-->`);
            ssrRenderList(__props.events, (event) => {
              _push2(`<div class="col-12 col-md-6 col-xl-4" data-v-90bc4bdd${_scopeId}><div class="card border-0 shadow-sm h-100" data-v-90bc4bdd${_scopeId}><div class="card-body" data-v-90bc4bdd${_scopeId}><div class="d-flex justify-content-between align-items-start mb-3" data-v-90bc4bdd${_scopeId}><span class="${ssrRenderClass(`badge ${event.is_active ? "bg-success" : "bg-secondary"}`)}" data-v-90bc4bdd${_scopeId}>${ssrInterpolate(event.is_active ? "Aktif" : "Nonaktif")}</span><div class="dropdown" data-v-90bc4bdd${_scopeId}><button class="btn btn-sm btn-light" type="button" data-bs-toggle="dropdown" data-v-90bc4bdd${_scopeId}><i class="bi bi-three-dots-vertical" data-v-90bc4bdd${_scopeId}></i></button><ul class="dropdown-menu dropdown-menu-end shadow border-0" data-v-90bc4bdd${_scopeId}><li data-v-90bc4bdd${_scopeId}><button class="dropdown-item" data-v-90bc4bdd${_scopeId}><i class="${ssrRenderClass(`bi ${event.is_active ? "bi-pause-circle" : "bi-play-circle"} me-2`)}" data-v-90bc4bdd${_scopeId}></i> ${ssrInterpolate(event.is_active ? "Nonaktifkan" : "Aktifkan")}</button></li><li data-v-90bc4bdd${_scopeId}><hr class="dropdown-divider" data-v-90bc4bdd${_scopeId}></li><li data-v-90bc4bdd${_scopeId}><button class="dropdown-item text-danger" data-v-90bc4bdd${_scopeId}><i class="bi bi-trash me-2" data-v-90bc4bdd${_scopeId}></i> Hapus Event </button></li></ul></div></div><h5 class="fw-bold mb-1" data-v-90bc4bdd${_scopeId}>${ssrInterpolate(event.name)}</h5><p class="text-muted small mb-3" data-v-90bc4bdd${_scopeId}>Slug: ${ssrInterpolate(event.slug)}</p><div class="d-flex align-items-center gap-3 mb-4" data-v-90bc4bdd${_scopeId}><div class="p-3 bg-light rounded-3 text-center flex-grow-1" data-v-90bc4bdd${_scopeId}><h4 class="fw-bold mb-0" data-v-90bc4bdd${_scopeId}>${ssrInterpolate(event.registrations_count)}</h4><span class="text-muted extra-small uppercase fw-bold" data-v-90bc4bdd${_scopeId}>Pendaftar</span></div><div class="flex-grow-1 text-center" data-v-90bc4bdd${_scopeId}>`);
              if (event.is_active) {
                _push2(`<a${ssrRenderAttr("href", `/seminar/nasional/register/${event.slug}`)} target="_blank" class="text-decoration-none small text-primary fw-bold" data-v-90bc4bdd${_scopeId}><i class="bi bi-link-45deg" data-v-90bc4bdd${_scopeId}></i> Lihat Form </a>`);
              } else {
                _push2(`<span class="text-muted small italic" data-v-90bc4bdd${_scopeId}>Form Tutup</span>`);
              }
              _push2(`</div></div><div class="d-grid" data-v-90bc4bdd${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Lihat Data &amp; Kelola <i class="bi bi-arrow-right ms-1" data-v-90bc4bdd${_scopeId2}></i>`);
                  } else {
                    return [
            ...
            if (__props.events.length === 0) {
              _push2(`<div class="col-12" data-v-90bc4bdd${_scopeId}><div class="card border-0 shadow-sm py-5 text-center" data-v-90bc4bdd${_scopeId}><div class="card-body text-muted" data-v-90bc4bdd${_scopeId}><i class="bi bi-calendar-x fs-1 d-block mb-3" data-v-90bc4bdd${_scopeId}></i><h5 data-v-90bc4bdd${_scopeId}>Belum ada event seminar</h5><p data-v-90bc4bdd${_scopeId}>Klik tombol &quot;Tambah Event Baru&quot; untuk memulai.</p></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="modal fade" id="modalAddEvent" tabindex="-1" data-v-90bc4bdd${_scopeId}><div class="modal-dialog modal-dialog-centered" data-v-90bc4bdd${_scopeId}><div class="modal-content border-0 shadow" data-v-90bc4bdd${_scopeId}><div class="modal-header border-0" data-v-90bc4bdd${_scopeId}><h5 class="modal-title fw-bold" data-v-90bc4bdd${_scopeId}>Tambah Event Seminar Baru</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-v-90bc4bdd${_scopeId}></button></div><div class="modal-body" data-v-90bc4bdd${_scopeId}><div class="mb-3" data-v-90bc4bdd${_scopeId}><label class="form-label fw-medium" data-v-90bc4bdd${_scopeId}>Nama Event</label><input${ssrRenderAttr("value", unref(formAdd).name)} type="text" class="form-control" placeholder="Contoh: Seminar Nasional SEEO 2025" required data-v-90bc4bdd${_scopeId}></div><div class="mb-3" data-v-90bc4bdd${_scopeId}><label class="form-label fw-medium" data-v-90bc4bdd${_scopeId}>Link Grup WhatsApp (Opsional)</label><input${ssrRenderAttr("value", unref(formAdd).wa_link)} type="text" class="form-control" placeholder="https://chat.whatsapp.com/..." data-v-90bc4bdd${_scopeId}><div class="form-text" data-v-90bc4bdd${_scopeId}>Peserta akan diarahkan ke link ini setelah mendaftar.</div></div></div><div class="modal-footer border-0" data-v-90bc4bdd${_scopeId}><button type="button" class="btn btn-light" data-bs-dismiss="modal" data-v-90bc4bdd${_scopeId}>Batal</button><button type="button" class="btn btn-primary"${ssrIncludeBooleanAttr(unref(formAdd).processing) ? " disabled" : ""} data-v-90bc4bdd${_scopeId}>${ssrInterpolate(unref(formAdd).processing ? "Menyimpan..." : "Buat Event")}</button></div></div></div></div>`);
          } else {
            return [
...
const SeminarRegistrations = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-90bc4bdd"]]);
export {
  SeminarRegistrations as default
};
//# sourceMappingURL=SeminarRegistrations-CwVmphxN.js.map
