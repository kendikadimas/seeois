import { ref, onMounted, onUnmounted, watch, withCtx, unref, createVNode, toDisplayString, Transition, openBlock, createBlock, createCommentVNode, Fragment, renderList, createTextVNode, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (active_tab.value == 1) {
              _push2(`<div class="row g-4 mt-0"${_scopeId}><div class="col-12 col-lg-8"${_scopeId}><div class="row g-4"${_scopeId}><div class="col-12"${_scopeId}><div class="card p-3 border-0"${_scopeId}><div class="d-flex pb-2"${_scopeId}><span class="text-primary-emphasis h6 my-auto"${_scopeId}>${ssrInterpolate("Taste Preference")}</span>`);
              ...
              _push2(`<!--]--></tbody></table></div></div></div></div></div></div></div><div class="col-12 col-lg-4"${_scopeId}><div class="card p-3 border-0"${_scopeId}><div class="d-flex"${_scopeId}><span class="h6 text-primary-emphasis"${_scopeId}>${ssrInterpolate("Menu Combo Pattern")}</span></div><div class="scroll-container-2 scroll-container-lg-3"${_scopeId}><li class="list-group list-group-flush"${_scopeId}><!--[-->`);
            ...
            if (active_tab.value == 2) {
              _push2(`<div class="row mt-0 g-4"${_scopeId}><div class="col-12 col-lg-6"${_scopeId}><div class="card p-3"${_scopeId}><div class="d-flex"${_scopeId}><span class="text-primary-emphasis h6"${_scopeId}>${ssrInterpolate("Customer Lifetime Value")}</span></div><table class="table mb-0 table-hover"${_scopeId}><thead${_scopeId}><tr${_scopeId}><td class="text-secondary text-center"${_scopeId}>${ssrInterpolate("Rank")}</td><td class="text-secondary"${_scopeId}>${ssrInterpolate("Customer")}</td><td class="text-secondary"${_scopeId}>${ssrInterpolate("Transaction")}</td><td class="text-secondary"${_scopeId}>${ssrInterpolate("Point")}</td></tr></thead><tbody class="scroll-container-3 scroll-container-lg-2"${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--></tbody></table></div></div><div class="col-12 col-lg-6"${_scopeId}><div class="card p-3"${_scopeId}><div class="d-flex"${_scopeId}><span class="text-primary-emphasis h6"${_scopeId}>${ssrInterpolate("Customer Rating & Feedback")}</span></div><div class="d-flex my-2 px-2 py-1"${_scopeId}><span class="text-secondary"${_scopeId}>${ssrInterpolate("Average Rating")}</span><div class="d-flex ms-auto"${_scopeId}><!--[-->`);
...
//# sourceMappingURL=Insight-loJNGJRY.js.map
