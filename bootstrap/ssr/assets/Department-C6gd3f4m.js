import { ref, onMounted, watch, withCtx, unref, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, withModifiers, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(StaffLayout, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a href="/seeo/staff/structural" class="bg-opacity-0 text-decoration-none text-primary-emphasis"${_scopeId}><span class="fw-light"${_scopeId}>${ssrInterpolate("Structural")}</span></a><span class="ms-2"${_scopeId}>${ssrInterpolate("/")}</span> ${ssrInterpolate(title.value)}`);
          } else {
            return [
              createVNode("a", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(auth_user).roles_id == 99 || unref(auth_user).id == __props.department.manager_id) {
            ...
            if (__props.department.staff.length > 0) {
              ...
              ssrRenderList(__props.department.staff, (staff, index) => {
                _push2(`<ul class="list-group-item list-group-item-action mb-0 py-2 px-0"${_scopeId}><a${ssrRenderAttr("id", "staff_" + (staff.id * 7 - 3))}${ssrRenderAttr("href", `/seeo/staff/profile/${staff.id}`)}${_scopeId}></a><div class="d-flex"${_scopeId}><span class="text-secondary border-end border-2 pe-2 me-2"${_scopeId}>${ssrInterpolate(index + 1)}</span><span class="text-dark d-flex"${_scopeId}>${ssrInterpolate(staff.name)} <i class="bi bi-box-arrow-up-right ms-2 my-auto" style="${ssrRenderStyle({ "font-size": "0.8rem" })}"${_scopeId}></i></span><button class="btn btn-sm btn-outline-secondary border-0 ms-auto py-0"${_scopeId}><i class="bi bi-trash3"${_scopeId}></i></button></div></ul>`);
              });
              _push2(`<!--]-->`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</li></div></div></div><div class="col-12 col-lg-6"${_scopeId}><div class="card sm p-3"${_scopeId}><div class="row"${_scopeId}><div class="col-12"${_scopeId}><div class="d-flex pb-2"${_scopeId}><span class="text-primary-emphasis me-auto my-auto h6"${_scopeId}><i class="bi bi-grid me-1"${_scopeId}></i> ${ssrInterpolate("Program List")}</span>`);
            if (unref(auth_user).roles_id == 99 || unref(auth_user).id == __props.department.manager_id) {
            ...
            if (__props.department.program.length > 0) {
              ...
              ssrRenderList(__props.department.program, (program, index) => {
                _push2(`<ul class="list-group-item list-group-item-action mb-0 py-2 px-0"${_scopeId}><div class="d-flex"${_scopeId}><span class="text-secondary border-end border-2 pe-2 me-2"${_scopeId}>${ssrInterpolate(index + 1)}</span><span class="text-dark d-flex"${_scopeId}>${ssrInterpolate(program.name)} <i class="bi bi-box-arrow-up-right ms-2 my-auto" style="${ssrRenderStyle({ "font-size": "0.8rem" })}"${_scopeId}></i></span><button class="btn btn-sm btn-outline-secondary border-0 ms-auto py-0"${_scopeId}><i class="bi bi-trash3"${_scopeId}></i></button></div></ul>`);
              });
              _push2(`<!--]-->`);
            } else {
              _push2(`<!---->`);
                ...
                createVNode("div", { class: "row mt-4" }, [
                  createVNode("div", { class: "col-12" }, [
                    createVNode("div", { class: "card p-3" }, [
                      createVNode("div", { class: "d-flex pb-1" }, [
                      ...
                      createVNode("div", { class: "row" }, [
                        createVNode("div", { class: "col-12" }, [
                          createVNode("div", { class: "d-flex pb-2" }, [
                            ...
                            unref(auth_user).roles_id == 99 || unref(auth_user).id == __props.department.manager_id ? (openBlock(), createBlock("button", {
                              key: 0,
                      ...
                      createVNode("div", { class: "scroll-container-2 scroll-container-lg-2" }, [
                        createVNode("li", { class: "list-group list-group-flush" }, [
                          ...
                          __props.department.program.length > 0 ? (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(__props.department.program, (program, index) => {
                            return openBlock(), createBlock("ul", {
                              onClick: withModifiers(($event) => _ctx.$inertia.visit("/seeo/staff/program/" + program.id), ["stop"]),
                              class: "list-group-item list-group-item-action mb-0 py-2 px-0"
                            }, [
                              createVNode("div", { class: "d-flex" }, [
                                createVNode("span", { class: "text-secondary border-end border-2 pe-2 me-2" }, toDisplayString(index + 1), 1),
...
//# sourceMappingURL=Department-C6gd3f4m.js.map
