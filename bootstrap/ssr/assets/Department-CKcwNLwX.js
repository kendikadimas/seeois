          ...
          if (_push2) {
            ...
            if (__props.department.staff.length > 0) {
              ...
              ssrRenderList(__props.department.staff, (staff, index) => {
                _push2(`<ul class="list-group-item list-group-item-action mb-0 py-2 px-0"${_scopeId}><a${ssrRenderAttr("id", "staff_" + (staff.id * 7 - 3))}${ssrRenderAttr("href", `/profile/${staff.id}`)}${_scopeId}></a><div class="d-flex"${_scopeId}><span class="text-secondary border-end border-2 pe-2 me-2"${_scopeId}>${ssrInterpolate(index + 1)}</span><span class="text-dark d-flex"${_scopeId}>${ssrInterpolate(staff.name)} <i class="bi bi-box-arrow-up-right ms-2 my-auto" style="${ssrRenderStyle({ "font-size": "0.8rem" })}"${_scopeId}></i></span><button class="btn btn-sm btn-outline-secondary border-0 ms-auto py-0"${_scopeId}><i class="bi bi-trash3"${_scopeId}></i></button></div></ul>`);
              });
              _push2(`<!--]-->`);
            } else {
              _push2(`<!---->`);
...
//# sourceMappingURL=Department-CKcwNLwX.js.map
