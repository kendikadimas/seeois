    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(StaffLayout, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a href="/blaterian/foods/stand" class="bg-opacity-0 text-decoration-none text-primary-emphasis"${_scopeId}><span class="fw-light"${_scopeId}>${ssrInterpolate("Stand")}</span></a><span class="mx-2"${_scopeId}>${ssrInterpolate("/")}</span><a${ssrRenderAttr("href", `/blaterian/foods/stand_detail/${__props.stand.id}`)} class="bg-opacity-0 text-decoration-none text-primary-emphasis"${_scopeId}><span class="fw-light"${_scopeId}>${ssrInterpolate(__props.stand.name)}</span></a><span class="mx-2"${_scopeId}>${ssrInterpolate("/")}</span> ${ssrInterpolate(title.value)}`);
          } else {
            return [
              createVNode("a", {
              ...
              createVNode("a", {
                href: `/blaterian/foods/stand_detail/${__props.stand.id}`,
                class: "bg-opacity-0 text-decoration-none text-primary-emphasis"
              }, [
...
//# sourceMappingURL=StandCashier-C2uYjBg9.js.map
