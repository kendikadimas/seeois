import { ref, computed, watch, resolveComponent, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, withDirectives, Fragment, renderList, vModelSelect, createTextVNode, vModelText, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_component_StaffLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></select></div></div></div></div></div><div class="col-12 col-xl-5"${_scopeId}><div class="card border-0 shadow-sm mb-4"${_scopeId}><div class="card-body text-center py-4"${_scopeId}><i class="bi bi-plus-circle text-primary fs-1 mb-3"${_scopeId}></i><h5${_scopeId}>Tambah Menu Baru</h5><p class="text-muted small mb-4"${_scopeId}>Tambahkan item menu baru untuk stand yang dipilih.</p><button class="btn btn-primary px-4"${_scopeId}><i class="bi bi-plus-lg me-2"${_scopeId}></i>Tambah Menu </button></div></div><div class="card border-0 shadow-sm"${_scopeId}><div class="card-header bg-transparent border-0 pt-4 pb-0"${_scopeId}><h5 class="mb-0"${_scopeId}>Bahan &amp; Biaya Produksi</h5></div><div class="card-body"${_scopeId}><div class="mb-3"${_scopeId}><label class="form-label"${_scopeId}>Pilih Menu</label><select class="form-select"${_scopeId}><!--[-->`);
            ...
            _push2(`</div></div></div><div class="col-12 col-xl-7"${_scopeId}><div class="card border-0 shadow-sm mb-4"${_scopeId}><div class="card-header bg-transparent border-0 pt-4 pb-0"${_scopeId}><h5 class="mb-0"${_scopeId}>Daftar Menu</h5></div><div class="card-body table-responsive"${_scopeId}><div class="row g-2 mb-3"${_scopeId}><div class="col-md-8"${_scopeId}><input${ssrRenderAttr("value", menuSearch.value)} type="search" class="form-control" placeholder="Cari menu atau kategori"${_scopeId}></div><div class="col-md-4 text-md-end"${_scopeId}><button class="btn btn-outline-secondary w-100"${_scopeId}>Reset Pencarian</button></div></div><table class="table align-middle"${_scopeId}><thead${_scopeId}><tr${_scopeId}><th${_scopeId}>Menu</th><th${_scopeId}>Biaya Produksi</th><th${_scopeId}>Harga Jual</th><th${_scopeId}>Status</th><th${_scopeId}></th></tr></thead><tbody${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("div", { class: "container-fluid py-4" }, [
                __props.notif ? (openBlock(), createBlock(_component_Notif, {
                  key: 0,
                  notif: __props.notif
                ...
                createVNode("div", { class: "row g-4" }, [
                      ...
                      createVNode("div", { class: "card-body" }, [
                        createVNode("div", { class: "d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-center" }, [
                          createVNode("div", null, [
                            ...
                            createVNode("p", { class: "text-muted mb-0" }, "Buat menu, hitung biaya produksi, publish ke shop, dan pantau pengantaran order.")
                          ]),
                  ...
                  createVNode("div", { class: "col-12 col-xl-5" }, [
                    createVNode("div", { class: "card border-0 shadow-sm mb-4" }, [
                      createVNode("div", { class: "card-body text-center py-4" }, [
                        createVNode("i", { class: "bi bi-plus-circle text-primary fs-1 mb-3" }),
                        createVNode("h5", null, "Tambah Menu Baru"),
                        createVNode("p", { class: "text-muted small mb-4" }, "Tambahkan item menu baru untuk stand yang dipilih."),
                        createVNode("button", {
                          class: "btn btn-primary px-4",
                          onClick: ($event) => showAddMenuModal()
                        }, [
                        ...
                        createVNode("div", { class: "row g-2 mb-3" }, [
                          createVNode("div", { class: "col-md-5" }, [
                            withDirectives(createVNode("input", {
                              ...
                              type: "search",
                              class: "form-control",
                              placeholder: "Cari pembeli / menu / opsi kirim"
                            }, null, 8, ["onUpdate:modelValue"]), [
...
//# sourceMappingURL=MenuBoard-B6a6SfVH.js.map
