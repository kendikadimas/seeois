            ...
            return [
              createVNode("section", { class: "relative min-h-screen flex items-center justify-center overflow-hidden bg-white" }, [
                createVNode("div", { class: "absolute inset-0" }, [
                  createVNode("div", { class: "absolute top-1/4 left-1/4 w-2 h-2 bg-slate-400 rounded-full animate-ping" }),
                  createVNode("div", {
                    class: "absolute top-3/4 right-1/4 w-2 h-2 bg-blue-400 rounded-full animate-ping",
                    style: { "animation-delay": "2s" }
                  }),
                  createVNode("div", {
                    class: "absolute top-1/2 left-3/4 w-2 h-2 bg-slate-400 rounded-full animate-ping",
                ...
                createVNode("div", { class: "relative z-10 max-w-6xl mx-auto px-6 text-center" }, [
                  createVNode("div", { class: "space-y-8" }, [
                    createVNode("div", { class: "inline-flex items-center px-4 py-2 bg-slate-100 text-slate-700 rounded-full text-sm font-medium" }, [
                      ...
                      createVNode("span", { class: "font-medium" }, "Fakultas Teknik Universitas Jenderal Soedirman")
                    ]),
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-5xl md:text-7xl lg:text-8xl font-bold text-slate-900 mb-6 leading-tight" }, [
                        ...
                        createVNode("span", { class: "block text-blue-600" }, " SEEO ")
                      ]),
                      createVNode("p", { class: "text-xl md:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed" }, " Student Entrepreneur and Empowerment Organization ")
                    ]),
                    createVNode("p", { class: "text-lg md:text-xl text-slate-500 max-w-3xl mx-auto" }, " Mencetak generasi wirausaha teknik yang inovatif, adaptif, dan berkelanjutan ")
                  ])
                ]),
                ...
                createVNode("div", { class: "relative z-10 max-w-7xl mx-auto px-6" }, [
                  createVNode("div", { class: "grid lg:grid-cols-2 gap-20 items-center" }, [
                    createVNode("div", null, [
                      ...
                      createVNode("h2", { class: "text-4xl md:text-5xl font-bold text-slate-900 mb-8 leading-tight" }, [
                        createTextVNode(" Perjalanan Membangun "),
                        createVNode("span", { class: "text-blue-600 block" }, " Ekosistem Entrepreneurship ")
                      ]),
                      createVNode("div", { class: "space-y-6 text-lg text-slate-700" }, [
                        ...
                        createVNode("p", { class: "leading-relaxed" }, [
                          ...
                          createVNode("strong", { class: "text-blue-600" }, "menggabungkan aspek teoritis dan praktis"),
                          createTextVNode(" secara adaptif dan berkelanjutan. ")
                        ]),
                        createVNode("p", { class: "leading-relaxed" }, [
                          createTextVNode(" Melalui berbagai program inovatif dan brand unggulan "),
                          createVNode("strong", { class: "text-blue-600" }, "Blaterian"),
                      ...
                      createVNode("div", { class: "grid grid-cols-3 gap-6 mt-12" }, [
                        createVNode("div", { class: "text-center" }, [
                          createVNode("div", { class: "text-3xl font-bold text-blue-600 mb-2" }, "10+"),
                          createVNode("div", { class: "text-sm text-slate-600" }, "Tahun Pengalaman")
                        ]),
                        createVNode("div", { class: "text-center" }, [
                          createVNode("div", { class: "text-3xl font-bold text-blue-600 mb-2" }, "100+"),
                          createVNode("div", { class: "text-sm text-slate-600" }, "Anggota Aktif")
                        ]),
                        createVNode("div", { class: "text-center" }, [
                          createVNode("div", { class: "text-3xl font-bold text-blue-600 mb-2" }, "50+"),
                          createVNode("div", { class: "text-sm text-slate-600" }, "Program Sukses")
                        ])
                      ])
                    ]),
                    createVNode("div", { class: "relative" }, [
                      createVNode("div", { class: "relative bg-blue-600 rounded-3xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500" }, [
                        createVNode("img", {
              ...
              createVNode("section", { class: "relative py-32 overflow-hidden" }, [
                createVNode("div", { class: "absolute inset-0 bg-slate-900" }, [
                ...
                createVNode("div", { class: "relative z-10 max-w-6xl mx-auto px-6" }, [
                  createVNode("div", { class: "text-center mb-20" }, [
                    ...
                    createVNode("h2", { class: "text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6" }, [
                      ...
                      createVNode("span", { class: "block text-blue-400" }, " Organisasi ")
                    ])
                  ]),
                    ...
                    createVNode("div", { class: "relative group" }, [
                      createVNode("div", { class: "bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-10 h-full hover:bg-white/10 transition-all duration-500" }, [
                        createVNode("div", { class: "text-center mb-8" }, [
                          createVNode("div", { class: "w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-6" }, [
                            (openBlock(), createBlock("svg", {
                        ...
                        createVNode("p", { class: "text-lg text-slate-300 leading-relaxed text-center" }, [
                          createTextVNode(" Menjadi Unit Kegiatan Mahasiswa Kewirausahaan yang "),
                          createVNode("span", { class: "text-blue-400 font-semibold" }, "unggul, inovatif, dan berkelanjutan"),
                    ...
                    createVNode("div", { class: "relative group" }, [
                      createVNode("div", { class: "bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-10 h-full hover:bg-white/10 transition-all duration-500" }, [
                        ...
                        createVNode("p", { class: "text-lg text-slate-300 leading-relaxed text-center" }, [
                          ...
                          createVNode("span", { class: "text-blue-400 font-semibold" }, "menggabungkan aspek teoritis dan praktis"),
              ...
              createVNode("section", { class: "relative py-32 overflow-hidden" }, [
                ...
                createVNode("div", { class: "relative z-10 max-w-7xl mx-auto px-6" }, [
                  createVNode("div", { class: "text-center mb-20" }, [
                    ...
                    createVNode("h2", { class: "text-4xl md:text-5xl font-bold text-slate-900 mb-6" }, [
                      createTextVNode(" Prinsip yang Kami "),
                      createVNode("span", { class: "text-blue-600 block" }, " Pegang Teguh ")
                    ]),
                  ...
                  createVNode("div", { class: "grid md:grid-cols-2 lg:grid-cols-3 gap-8" }, [
                    createVNode("div", { class: "group bg-white rounded-3xl p-8 shadow-lg border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500" }, [
                      createVNode("div", { class: "w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300" }, [
                        (openBlock(), createBlock("svg", {
                    ...
                    createVNode("div", { class: "group bg-white rounded-3xl p-8 shadow-lg border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 md:col-span-2 lg:col-span-1" }, [
                      createVNode("div", { class: "w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300" }, [
                        (openBlock(), createBlock("svg", {
                          class: "w-8 h-8 text-white",
                          fill: "none",
                  ...
                  createVNode("div", { class: "text-center mt-20" }, [
                    createVNode("div", { class: "bg-blue-600 rounded-3xl p-12 text-white" }, [
                      ...
                      createVNode("p", { class: "text-xl text-white mb-8 max-w-2xl mx-auto" }, " Mari bersama-sama membangun masa depan entrepreneurship yang lebih cerah "),
...
//# sourceMappingURL=About-Epi_2ndM.js.map
