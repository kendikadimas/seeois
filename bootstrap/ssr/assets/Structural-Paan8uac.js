import { unref, mergeProps, createSlots, renderList, withCtx, renderSlot, useSSRContext, ref, onMounted, onUnmounted, watch, createVNode, toDisplayString, createTextVNode, withDirectives, vModelText, openBlock, createBlock, createCommentVNode, Fragment, withModifiers } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderStyle, ssrRenderList } from "vue/server-renderer";
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(vSelect), mergeProps(_ctx.$attrs, _attrs), createSlots({ _: 2 }, [
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/VueSelect.vue");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.department_list, (item) => {
              _push2(`<div class="col-lg-4 col-12"${_scopeId}><div class="card department-card p-3 mb-3 mb-lg-4" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}><div class="d-flex"${_scopeId}><div class="" style="${ssrRenderStyle({ "font-size": "0.8rem" })}"${_scopeId}><span class="text-secondary d-block mb-1"${_scopeId}><i class="bi bi-person-badge me-1"${_scopeId}></i> ${ssrInterpolate(item.manager.name)}</span><span class="h5 text-primary-emphasis d-block card-title"${_scopeId}><i class="bi bi-building me-2"${_scopeId}></i> ${ssrInterpolate("Department " + item.name)}</span></div><div class="ms-auto mb-auto d-flex" style="${ssrRenderStyle({ "z-index": "10", "position": "relative" })}"${_scopeId}>`);
              if (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) {
                _push2(`<button class="border-0 btn btn-sm btn-outline-secondary" title="Edit Department"${_scopeId}><i class="bi bi-pencil"${_scopeId}></i></button>`);
              } else {
                _push2(`<!---->`);
              }
              if (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) {
              ...
              if (unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99) {
                _push2(`<button class="border-0 btn btn-sm btn-outline-secondary" title="Delete Department"${_scopeId}><i class="bi bi-trash3"${_scopeId}></i></button>`);
              } else {
                _push2(`<!---->`);
              }
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.department_list, (item) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", {
                        ...
                        onClick: ($event) => _ctx.$inertia.visit(`/seeo/staff/department/${item.id}`)
                      }, [
                        createVNode("div", { class: "d-flex" }, [
                          createVNode("div", {
                            class: "",
                            ...
                            createVNode("span", { class: "text-secondary d-block mb-1" }, [
                              createVNode("i", { class: "bi bi-person-badge me-1" }),
                              createTextVNode(" " + toDisplayString(item.manager.name), 1)
                            ]),
                            createVNode("span", { class: "h5 text-primary-emphasis d-block card-title" }, [
                              createVNode("i", { class: "bi bi-building me-2" }),
                              createTextVNode(" " + toDisplayString("Department " + item.name), 1)
                            ])
                          ]),
                          createVNode("div", {
                            class: "ms-auto mb-auto d-flex",
                            ...
                            unref(auth_user).roles_id == 1 || unref(auth_user).roles_id == 99 ? (openBlock(), createBlock("button", {
                              ...
                              onClick: withModifiers(
                                () => {
                                  ...
                                  unref(form_update_department).name = item.name;
                                  unref(form_update_department).manager_id = item.manager_id;
...
//# sourceMappingURL=Structural-Paan8uac.js.map
