import { ref, computed, onMounted, onUnmounted, watch, withCtx, unref, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, Transition, Fragment, renderList, withDirectives, vModelText, useSSRContext } from "vue";
...
import { f as formatIDR, a as formatDate, s as showImage } from "./utils-DIF4pdrF.js";
      ...
      _push(ssrRenderComponent(GuestLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            )} alt="image" class="rounded img-fluid object-fit-cover placeholder" style="${ssrRenderStyle({ "width": "3rem", "height": "3rem" })}"${_scopeId}><div class="px-2"${_scopeId}><h6 class="mb-0"${_scopeId}>${ssrInterpolate(((_e = unref(auth_user)) == null ? void 0 : _e.name) ?? "Guest")}</h6><span class="fw-light"${_scopeId}>${ssrInterpolate(unref(auth_user) ? ((_f = unref(auth_user).roles) == null ? void 0 : _f.name) ?? "Customer" : "Please Login")}</span></div></div><button type="button" class="btn btn-sm btn-outline-warning border-0 ms-auto" data-bs-dismiss="offcanvas" aria-label="Close"${_scopeId}>${ssrInterpolate("Close")} <i class="bi bi-chevron-right"${_scopeId}></i></button></div><div class="offcanvas-body"${_scopeId}><ul class="list-group list-group-flush"${_scopeId}><li class="list-group-item list-group-item-action"${_scopeId}><a${ssrRenderAttr("href", _ctx.route("login"))}${_scopeId}></a><div class="d-flex fs-5"${_scopeId}><i class="bi bi-house me-2"${_scopeId}></i> ${ssrInterpolate("Home")}</div></li>`);
            if (unref(auth_user)) {
              ...
              ssrRenderList(__props.stand_list, (stand) => {
                ...
                ssrRenderList(stand.menu.slice(
                  ...
                  _push2(`<div class="card card-bg-hover shadow-sm d-inline-block p-0 ms-2 me-2 rounded"${_scopeId}><img${ssrRenderAttr(
                    "src",
                    menu.image ? "/storage/images/shop/foods/menu/" + menu.image : logoSrc
                                        ...
                                        createVNode("div", { class: "scroll-container-horizontal scroll-container-horizontal-lg scroll-thumb-warning py-1 mt-1 bg-warning bg-opacity-25 rounded" }, [
                                          (openBlock(true), createBlock(Fragment, null, renderList(stand.menu.slice(
                                            ...
                                            return openBlock(), createBlock("div", { class: "card card-bg-hover shadow-sm d-inline-block p-0 ms-2 me-2 rounded" }, [
                                              createVNode("img", {
                                                src: menu.image ? "/storage/images/shop/foods/menu/" + menu.image : logoSrc,
                                                alt: "",
...
//# sourceMappingURL=Shop-sz9Xtuet.js.map
