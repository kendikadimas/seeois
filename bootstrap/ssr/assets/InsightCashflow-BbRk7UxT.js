import { ref, computed, onMounted, onUnmounted, watch, withCtx, unref, createVNode, toDisplayString, createTextVNode, Transition, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(StaffLayout, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a${ssrRenderAttr("href", `/seeo/staff/blaterian/insight`)} class="bg-opacity-0 text-decoration-none text-primary-emphasis"${_scopeId}><span class="fw-light"${_scopeId}>${ssrInterpolate("Business Insight")}</span></a><span class="ms-2"${_scopeId}>${ssrInterpolate("/")}</span> ${ssrInterpolate(title.value)}`);
          } else {
            return [
              createVNode("a", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (isLargeScreen.value || opened_detail.value == "foods") {
              ...
              _push2(`</button></div></div></div><div class="d-flex mt-2 ms-2"${_scopeId}><span class="text-primary pe-3 me-3 my-auto h6"${_scopeId}>${ssrInterpolate("Filter")}</span><button class="btn btn-sm btn-outline-secondary border-1 rounded-2 border-secondary-subtle py-0"${_scopeId}>${ssrInterpolate("Date")} <i class="${ssrRenderClass(
                ...
                createVNode("div", { class: "row mt-4" }, [
                  createVNode("div", { class: "col-12" }, [
                    createVNode("div", { class: "card bg-white p-3" }, [
                      createVNode("div", { class: "pb-1 d-flex" }, [
                      ...
                      isLargeScreen.value || opened_detail.value == "foods" ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "card p-2" }, [
                          ...
                          createVNode("div", { class: "d-flex mt-2 ms-2" }, [
                            createVNode("span", { class: "text-primary pe-3 me-3 my-auto h6" }, toDisplayString("Filter")),
                            createVNode("button", {
...
//# sourceMappingURL=InsightCashflow-BbRk7UxT.js.map
