    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="preconnect" href="https://fonts.googleapis.com" data-v-9dec554a${_scopeId}><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin data-v-9dec554a${_scopeId}><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet" data-v-9dec554a${_scopeId}><link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css" rel="stylesheet" data-v-9dec554a${_scopeId}>`);
          } else {
            return [
              createVNode("link", {
                rel: "preconnect",
      ...
      _push(`<div class="d-flex vh-100 overflow-x-hidden" data-v-9dec554a><div class="sidebar-desktop d-none d-lg-flex flex-column shrink-0 bg-gradient-custom text-white" data-v-9dec554a><div class="sidebar-content-inner p-3" data-v-9dec554a><div class="sidebar-logo mb-4" data-v-9dec554a><a${ssrRenderAttr("href", route("dashboard"))} class="text-decoration-none" data-v-9dec554a><div class="d-flex align-items-center p-2 rounded bg-white bg-opacity-10 sidebar-logo-hover" data-v-9dec554a><img${ssrRenderAttr("src", logoSrc)} alt="SEEO Logo" class="sidebar-logo-img me-2" data-v-9dec554a><div class="lh-sm" data-v-9dec554a><h5 class="sidebar-logo-title mb-0 text-white" data-v-9dec554a>SEEO</h5><span class="sidebar-logo-subtitle d-block text-white" data-v-9dec554a>Information System</span><small class="sidebar-logo-version text-warning" data-v-9dec554a>v5.0</small></div></div></a></div><div class="navigation-menu grow" data-v-9dec554a><!--[-->`);
      ssrRenderList(nav_list.value, (sectionContent, sectionKey) => {
        _push(`<div class="nav-section mb-2" data-v-9dec554a><button type="button" class="${ssrRenderClass([{ "active-section": active_section.value == sectionKey, "open": openedSections.value[sectionKey] }, "nav-header btn w-100 text-start d-flex align-items-center"])}" data-v-9dec554a><i${ssrRenderAttr("id", "icon_nav_section_desktop_" + sectionKey.replace(/\s+/g, ""))} class="${ssrRenderClass(["bi", "me-2", openedSections.value[sectionKey] ? "bi-chevron-up" : "bi-chevron-down"])}" data-v-9dec554a></i><i class="${ssrRenderClass(["bi", getSectionIcon(sectionKey), "me-2", "text-warning"])}" data-v-9dec554a></i><span class="fw-semibold" data-v-9dec554a>${ssrInterpolate(sectionKey)}</span></button><div style="${ssrRenderStyle(openedSections.value[sectionKey] ? null : { display: "none" })}"${ssrRenderAttr("id", "nav_section_desktop_" + sectionKey.replace(/\s+/g, ""))} data-v-9dec554a><div class="nav-items pt-1 ps-3" data-v-9dec554a><!--[-->`);
        ssrRenderList(sectionContent, (nav_group, nav_group_key) => {
          _push(`<div class="mb-1" data-v-9dec554a>`);
          if (Array.isArray(nav_group)) {
            _push(`<!--[--><button type="button" class="${ssrRenderClass([{ "active-group": active_group.value == nav_group_key, "open": openedGroups.value[`${sectionKey}_${nav_group_key}`] }, "nav-item nav-group d-flex align-items-center btn text-start w-100"])}" data-v-9dec554a><i${ssrRenderAttr("id", "icon_nav_group_desktop_" + sectionKey.replace(/\s+/g, "") + "_" + nav_group_key.replace(/\s+/g, ""))} class="${ssrRenderClass(["bi", "me-2", "nav-group-icon", openedGroups.value[`${sectionKey}_${nav_group_key}`] ? "bi-chevron-up" : "bi-chevron-down"])}" data-v-9dec554a></i><span class="fw-medium" data-v-9dec554a>${ssrInterpolate(nav_group_key)}</span></button><div style="${ssrRenderStyle(openedGroups.value[`${sectionKey}_${nav_group_key}`] ? null : { display: "none" })}"${ssrRenderAttr("id", "nav_group_desktop_" + sectionKey.replace(/\s+/g, "") + "_" + nav_group_key.replace(/\s+/g, ""))} data-v-9dec554a><!--[-->`);
            ssrRenderList(nav_group, (nav, index) => {
              _push(`<a${ssrRenderAttr("href", nav.route)} class="${ssrRenderClass(["nav-item", "sub-item", "d-flex", "align-items-center", nav.active ? "active" : ""])}" data-v-9dec554a>`);
              if (nav.icon) {
                _push(`<i class="${ssrRenderClass(["bi", nav.icon, "me-2"])}" data-v-9dec554a></i>`);
              } else {
                _push(`<!---->`);
              }
          ...
          if (!Array.isArray(nav_group) && typeof nav_group === "object" && nav_group !== null && nav_group.route !== void 0) {
            _push(`<a${ssrRenderAttr("href", nav_group.route)} class="${ssrRenderClass(["nav-item", "d-flex", "align-items-center", nav_group.active ? "active" : ""])}" data-v-9dec554a>`);
            if (nav_group.icon) {
              _push(`<i class="${ssrRenderClass(["bi", nav_group.icon, "me-2"])}" data-v-9dec554a></i>`);
            } else {
              _push(`<!---->`);
            }
      ...
      _push(`<!--]--></div></div></div><div class="offcanvas offcanvas-start bg-gradient-custom text-white sidebar-mobile" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel" data-v-9dec554a><div class="offcanvas-header border-bottom border-white border-opacity-25" data-v-9dec554a><a${ssrRenderAttr("href", route("dashboard"))} class="text-decoration-none" data-v-9dec554a><div class="d-flex align-items-center" data-v-9dec554a><img${ssrRenderAttr("src", logoSrc)} alt="SEEO Logo" class="sidebar-logo-img me-2" data-v-9dec554a><div class="lh-sm" data-v-9dec554a><h5 class="sidebar-logo-title mb-0 text-white" id="sidebarOffcanvasLabel" data-v-9dec554a>SEEO</h5><span class="sidebar-logo-subtitle d-block text-white" data-v-9dec554a>Information System</span></div></div></a><button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close" data-v-9dec554a></button></div><div class="offcanvas-body sidebar-content-inner p-3" data-v-9dec554a><div class="navigation-menu grow" data-v-9dec554a><!--[-->`);
      ssrRenderList(nav_list.value, (sectionContent, sectionKey) => {
        _push(`<div class="nav-section mb-2" data-v-9dec554a><button type="button" class="${ssrRenderClass([{ "active-section": active_section.value == sectionKey, "open": openedSections.value[sectionKey] }, "nav-header btn w-100 text-start d-flex align-items-center"])}" data-v-9dec554a><i${ssrRenderAttr("id", "icon_nav_section_mobile_" + sectionKey.replace(/\s+/g, ""))} class="${ssrRenderClass(["bi", "me-2", openedSections.value[sectionKey] ? "bi-chevron-up" : "bi-chevron-down"])}" data-v-9dec554a></i><i class="${ssrRenderClass(["bi", getSectionIcon(sectionKey), "me-2", "text-warning"])}" data-v-9dec554a></i><span class="fw-semibold" data-v-9dec554a>${ssrInterpolate(sectionKey)}</span></button><div style="${ssrRenderStyle(openedSections.value[sectionKey] ? null : { display: "none" })}"${ssrRenderAttr("id", "nav_section_mobile_" + sectionKey.replace(/\s+/g, ""))} data-v-9dec554a><div class="nav-items pt-1 ps-3" data-v-9dec554a><!--[-->`);
        ssrRenderList(sectionContent, (nav_group, nav_group_key) => {
          _push(`<div class="mb-1" data-v-9dec554a>`);
          if (Array.isArray(nav_group)) {
            _push(`<!--[--><button type="button" class="${ssrRenderClass([{ "active-group": active_group.value == nav_group_key, "open": openedGroups.value[`${sectionKey}_${nav_group_key}`] }, "nav-item nav-group d-flex align-items-center btn text-start w-100"])}" data-v-9dec554a><i${ssrRenderAttr("id", "icon_nav_group_mobile_" + sectionKey.replace(/\s+/g, "") + "_" + nav_group_key.replace(/\s+/g, ""))} class="${ssrRenderClass(["bi", "me-2", "nav-group-icon", openedGroups.value[`${sectionKey}_${nav_group_key}`] ? "bi-chevron-up" : "bi-chevron-down"])}" data-v-9dec554a></i><span class="fw-medium" data-v-9dec554a>${ssrInterpolate(nav_group_key)}</span></button><div style="${ssrRenderStyle(openedGroups.value[`${sectionKey}_${nav_group_key}`] ? null : { display: "none" })}"${ssrRenderAttr("id", "nav_group_mobile_" + sectionKey.replace(/\s+/g, "") + "_" + nav_group_key.replace(/\s+/g, ""))} data-v-9dec554a><!--[-->`);
            ssrRenderList(nav_group, (nav, index) => {
              _push(`<a${ssrRenderAttr("href", nav.route)} class="${ssrRenderClass(["nav-item", "sub-item", "d-flex", "align-items-center", nav.active ? "active" : ""])}" data-v-9dec554a>`);
              if (nav.icon) {
                _push(`<i class="${ssrRenderClass(["bi", nav.icon, "me-2"])}" data-v-9dec554a></i>`);
      ...
      _push(`<!--]--></div></div></div><div class="main-content-wrapper grow d-flex flex-column overflow-hidden position-relative" data-v-9dec554a>`);
      if (_ctx.$slots.header) {
        _push(`<header class="top-header bg-white border-bottom shadow-sm px-2 px-lg-3 py-2 position-relative z-dropdown" data-v-9dec554a><div class="d-flex justify-content-between align-items-center" data-v-9dec554a><button class="btn border-0 d-lg-none p-1 me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarOffcanvas" aria-controls="sidebarOffcanvas" data-v-9dec554a><i class="bi bi-list fs-3" data-v-9dec554a></i></button><div class="page-title me-auto" data-v-9dec554a><h4 class="mb-0 fs-5 fw-semibold" data-v-9dec554a>`);
        ssrRenderSlot(_ctx.$slots, "header", {}, null, _push, _parent);
        _push(`</h4><div class="page-meta small text-muted" data-v-9dec554a><span data-v-9dec554a>${ssrInterpolate(date_header.value)}</span><span class="mx-1 d-none d-md-inline" data-v-9dec554a>•</span><span class="d-none d-md-inline" data-v-9dec554a>${ssrInterpolate(currentTime.value)}</span></div></div>`);
        if (can_switch_year.value) {
          _push(`<div class="me-2 d-none d-md-flex align-items-center gap-2" data-v-9dec554a><span class="small text-muted" data-v-9dec554a>Tahun</span><select class="form-select form-select-sm" style="${ssrRenderStyle({ "width": "110px" })}" data-v-9dec554a><!--[-->`);
          ssrRenderList(available_years.value, (y) => {
            _push(`<option${ssrRenderAttr("value", y)} data-v-9dec554a${ssrIncludeBooleanAttr(Array.isArray(selected_year.value) ? ssrLooseContain(selected_year.value, y) : ssrLooseEqual(selected_year.value, y)) ? " selected" : ""}>${ssrInterpolate(y)}</option>`);
          });
          _push(`<!--]--></select></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="user-profile dropdown" data-v-9dec554a><button class="profile-btn btn d-flex align-items-center dropdown-toggle border-0" type="button" id="profileDropdownMenu" data-bs-toggle="dropdown" aria-expanded="false" data-v-9dec554a><img${ssrRenderAttr("src", ((_a = auth_user.value) == null ? void 0 : _a.full_profile_image_url) || `https://ui-avatars.com/api/?name=${encodeURIComponent(((_b = auth_user.value) == null ? void 0 : _b.name) || "User")}&color=7F9CF5&background=EBF4FF`)} alt="Profile" class="profile-img rounded-circle me-2" style="${ssrRenderStyle({ "width": "40px", "height": "40px", "object-fit": "cover" })}" data-v-9dec554a><div class="profile-info d-none d-lg-block lh-sm text-start" data-v-9dec554a><h6 class="mb-0 small fw-medium text-dark text-truncate" style="${ssrRenderStyle({ "max-width": "150px" })}" data-v-9dec554a>${ssrInterpolate((_c = auth_user.value) == null ? void 0 : _c.name)}</h6><small class="text-muted d-block text-truncate" style="${ssrRenderStyle({ "max-width": "150px" })}" data-v-9dec554a>${ssrInterpolate(((_d = auth_user.value) == null ? void 0 : _d.role_name) || "Staff")}</small></div></button><ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2" aria-labelledby="profileDropdownMenu" data-v-9dec554a><li data-v-9dec554a><a${ssrRenderAttr("href", route("profile.edit"))} class="dropdown-item small" data-v-9dec554a><i class="bi bi-person-circle me-2" data-v-9dec554a></i><span data-v-9dec554a>Profile</span></a></li><li data-v-9dec554a><hr class="dropdown-divider my-1" data-v-9dec554a></li><li data-v-9dec554a><a class="dropdown-item text-danger small" href="#" data-v-9dec554a><i class="bi bi-box-arrow-right me-2" data-v-9dec554a></i><span data-v-9dec554a>Logout</span></a></li></ul></div></div></header>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<main class="content-container grow overflow-auto" data-v-9dec554a>`);
...
const StaffLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9dec554a"]]);
export {
  StaffLayout as S
};
//# sourceMappingURL=StaffLayout-CmduQjnL.js.map
