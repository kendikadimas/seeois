                ...
                <div class="card shadow-lg border-0 rounded-4" style="width: 100%; max-width: 450px;">
                    <div class="card-body p-4 p-lg-5">
                        <div class="text-center mb-4">
                            ...
                            <h2 class="h3 fw-bold">Daftar Akun</h2>
                            <p class="text-muted">Bergabung bersama SEEO!</p>
                        </div>
                        <form @submit.prevent="submit_register">
                            <div class="mb-3 form-floating">
                                ...
                                <InputError :message="form_register.errors.name" class="mt-1" />
                            </div>
                            <div class="mb-3 form-floating">
                                <input
                                    id="email"
                                ...
                                <InputError :message="form_register.errors.email" class="mt-1" />
                            </div>
                            <div class="mb-3 form-floating">
                                <input
                                    id="phone"
                                ...
                                <InputError :message="form_register.errors.phone" class="mt-1" />
                            </div>
                            <div class="mb-3 form-floating position-relative">
                                ...
                                <InputError :message="form_register.errors.password" class="mt-1" />
                            </div>
                            <div class="mb-3 form-floating position-relative">
                                <input
                                ...
                                <InputError :message="form_register.errors.password_confirmation" class="mt-1" />
                            </div>
                            ...
                            <div class="d-grid mb-3">
                                ...
                                >
                                    <span v-if="form_register.processing" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                    <span v-if="form_register.processing"> Memproses...</span>
